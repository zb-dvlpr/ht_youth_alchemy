...
- Drag-and-drop lineup and bench builder with per-slot orientations and submit/load match orders
- Match list with orders status and per-match actions
- Localization, dark mode, notifications, and help overlay
