...
const MANUAL_MARKDOWN_WITH_CHRONICLE_TEAM_ATTITUDE_NOTE =
  MANUAL_MARKDOWN_WITH_TRANSFER_SEARCH_MOBILE_NOTE.replace(
    ...
    "If a team always plays 3-5-2 with the same tactic, that is information.\n  If they suddenly switch, that is also information.\n  If they have no pattern, congratulations, you are scouting chaos.\n\n  ### Team Attitude\n\n  The Team Attitude panel builds on that same formation baseline. It keeps only league and cup matches played in the team’s most common formation, compares the team’s midfield rating across those matches, and labels each analyzed match as PIC, MOTS, or normal. For matches that look like PIC or MOTS, it also checks lineup similarity against the baseline squad and downgrades the verdict to potentially PIC or potentially MOTS when the overlap is too low.\n\n  In the main panel you see only the latest detected non-normal instance and its date for each team. Clicking a team opens the analyzed match list with date, match type, and inferred attitude."
  );
