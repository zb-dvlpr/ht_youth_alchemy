...
export type Messages = {
  ...
  reminderBellLabel: string;
  remindersTitle: string;
  reminderDueNow: string;
  reminderSnoozed: string;
  reminderDismiss: string;
  reminderSnooze: string;
  reminderSnooze6Hours: string;
  ...
  reminderOpenModal: string;
  reminderNoDue: string;
  ...
  appLicenseFeatureChronicleLikelyTrainingDescription: string;
  appLicenseFeatureChronicleTrackingTitle: string;
  appLicenseFeatureChronicleTrackingDescription: string;
  ...
  settingsLicenseLoading: string;
  settingsLicenseStatusLabel: string;
  settingsLicenseStatusActive: string;
  settingsLicenseStatusInactive: string;
  settingsLicenseStatusExpired: string;
  settingsLicenseStatusDisabled: string;
  settingsLicenseDetailStatus: string;
  settingsLicenseDetailKey: string;
  settingsLicenseDetailActivationLimit: string;
  settingsLicenseDetailActivationUsage: string;
  settingsLicenseDetailCreatedAt: string;
  settingsLicenseDetailExpiresAt: string;
  settingsLicenseDetailInstanceId: string;
  settingsLicenseDetailInstanceName: string;
  settingsLicenseDetailInstanceCreatedAt: string;
  settingsLicenseDetailStoreId: string;
  settingsLicenseDetailOrderItemId: string;
  settingsLicenseDetailProductId: string;
  settingsLicenseDetailProduct: string;
  settingsLicenseDetailVariantId: string;
  settingsLicenseDetailVariant: string;
  settingsLicenseDetailOrderId: string;
  settingsLicenseDetailCustomerId: string;
  settingsLicenseDetailCustomerName: string;
  settingsLicenseDetailCustomerEmail: string;
  settingsLicenseNeverExpires: string;
  ...
  settingsStorageManagementLocalStorageTitle: string;
  settingsStorageManagementIndexedDbTitle: string;
  settingsStorageManagementTotalUsed: string;
  settingsStorageManagementIndexedDbTotalUsed: string;
  settingsStorageManagementIndexedDbDatabaseColumn: string;
  settingsStorageManagementIndexedDbStoreColumn: string;
  settingsStorageManagementIndexedDbRecordsColumn: string;
  settingsStorageManagementKeyColumn: string;
  ...
  settingsStorageManagementWipeIndexedDbButton: string;
  settingsStorageManagementNoKeys: string;
  settingsStorageManagementNoIndexedDbRecords: string;
  ...
  settingsStorageManagementWipeIndexedDbConfirmTitle: string;
  settingsStorageManagementWipeIndexedDbConfirmBody: string;
  ...
  settingsStorageManagementWipeIndexedDbSuccess: string;
  settingsStorageManagementWipeIndexedDbError: string;
  settingsStorageManagementReadError: string;
  settingsStorageManagementIndexedDbReadError: string;
  ...
  settingsDebugStorageTitle: string;
  settingsDebugStorageLoading: string;
  settingsDebugStorageOriginEstimateLabel: string;
  settingsDebugStorageOriginUnavailable: string;
  settingsDebugStorageLocalStorageApproxLabel: string;
  settingsDebugStorageBreakdownKeyColumn: string;
  settingsDebugStorageBreakdownUsageColumn: string;
  settingsDebugStorageNoLocalStorageKeys: string;
  settingsDebugStorageRefreshButton: string;
  settingsDebugStorageError: string;
  ...
  teamSpiritManuallyOverridden: string;
  ...
  teamSpiritCoachLeadershipDefaultWarning: string;
  ...
  teamSpiritDailyUpdates: string;
  teamSpiritAfterRecovery: string;
  ...
  teamSpiritLevel_3_5: string;
  teamSpiritLevel_4_5: string;
  teamSpiritLevel_5_5: string;
  teamSpiritLevel_6_5: string;
  teamSpiritLevel_7_5: string;
  teamSpiritLevel_8_5: string;
  teamSpiritLevel_9_5: string;
  teamSpiritLevel_10_5: string;
  ...
  seniorOtherOrdersButton: string;
  seniorOtherOrdersTitle: string;
  seniorOtherOrdersTooltip: string;
  seniorOtherOrdersDisabledTooltip: string;
  seniorOtherOrdersManMarkingTitle: string;
  seniorOtherOrdersManMarkingNone: string;
  seniorOtherOrdersSubstitutionsTitle: string;
  seniorOtherOrdersSubstitutionsNone: string;
  seniorOtherOrdersPenaltyTakersTitle: string;
  seniorOtherOrdersPenaltyTakersNone: string;
  seniorOtherOrdersCaptainTitle: string;
  seniorOtherOrdersCoachPick: string;
  seniorOtherOrdersSetPiecesTitle: string;
  seniorOtherOrdersMinuteLabel: string;
  seniorOtherOrdersPlayerInLabel: string;
  seniorOtherOrdersPlayerOutLabel: string;
  seniorOtherOrdersOrderTypeLabel: string;
  seniorOtherOrdersReplaceLabel: string;
  seniorOtherOrdersSwapLabel: string;
  seniorOtherOrdersRepositionLabel: string;
  seniorOtherOrdersUnknownOrderLabel: string;
  seniorOtherOrdersSpecialOrderLabel: string;
  seniorOtherOrdersConditionsLabel: string;
  seniorOtherOrdersCardLabel: string;
  seniorOtherOrdersStandingLabel: string;
  seniorOtherOrdersSave: string;
  seniorOtherOrdersCancel: string;
  seniorOtherOrdersMatchAttitudeTitle: string;
  seniorOtherOrdersMatchAttitudeUnavailable: string;
  seniorOtherOrdersAttitudeNormal: string;
  seniorOtherOrdersAttitudePlayItCool: string;
  seniorOtherOrdersAttitudeMatchOfSeason: string;
  seniorOtherOrdersStyleOfPlayTitle: string;
  seniorOtherOrdersStyleUnavailable: string;
  seniorOtherOrdersStyleDefensive: string;
  seniorOtherOrdersNeutral: string;
  seniorOtherOrdersStyleOffensive: string;
  seniorOtherOrdersTacticalAssistantLevel: string;
  seniorOtherOrdersTacticalAssistantDetected: string;
  seniorOtherOrdersTacticalAssistantSimulated: string;
  seniorOtherOrdersTacticalAssistantNone: string;
  seniorOtherOrdersTacticalAssistantUnknownLevel: string;
  ...
  seniorOtherOrdersNoStartingXiPlayers: string;
  seniorOtherOrdersNoBenchPlayers: string;
  seniorOtherOrdersAnyMinute: string;
  seniorOtherOrdersMinuteAfter: string;
  seniorOtherOrdersHalftime: string;
  seniorOtherOrdersBeforeExtraTime: string;
  seniorOtherOrdersStandingAny: string;
  seniorOtherOrdersStandingTied: string;
  seniorOtherOrdersStandingLead: string;
  seniorOtherOrdersStandingDown: string;
  seniorOtherOrdersStandingLeadMoreThanOne: string;
  seniorOtherOrdersStandingDownMoreThanOne: string;
  seniorOtherOrdersStandingNotDown: string;
  seniorOtherOrdersStandingNotLead: string;
  seniorOtherOrdersStandingLeadMoreThanTwo: string;
  seniorOtherOrdersStandingDownMoreThanTwo: string;
  seniorOtherOrdersStandingNotTied: string;
  seniorOtherOrdersRedCardIgnore: string;
  seniorOtherOrdersRedCardMyPlayer: string;
  seniorOtherOrdersRedCardOpponent: string;
  seniorOtherOrdersRedCardMyCentralDefender: string;
  seniorOtherOrdersRedCardMyMidfielder: string;
  seniorOtherOrdersRedCardMyForward: string;
  seniorOtherOrdersRedCardMyWingBack: string;
  seniorOtherOrdersRedCardMyWinger: string;
  seniorOtherOrdersRedCardOpponentCentralDefender: string;
  seniorOtherOrdersRedCardOpponentMidfielder: string;
  seniorOtherOrdersRedCardOpponentForward: string;
  seniorOtherOrdersRedCardOpponentWingBack: string;
  seniorOtherOrdersRedCardOpponentWinger: string;
  seniorOtherOrdersDeprecatedRedCardCriterion: string;
  seniorOtherOrdersSubstitutionLabel: string;
  ...
  seniorOtherOrdersManMarkingSourceModifiedLoaded: string;
  seniorOtherOrdersManMarkingWhyTargetTitle: string;
  seniorOtherOrdersManMarkingWhyMarkerTitle: string;
  seniorOtherOrdersManMarkingExpectedEffectTitle: string;
  seniorOtherOrdersManMarkingAlternativesTitle: string;
  seniorOtherOrdersManMarkingTargetAssessmentTitle: string;
  seniorOtherOrdersManMarkingMarkerAssessmentTitle: string;
  seniorOtherOrdersManMarkingPairAssessmentTitle: string;
  seniorOtherOrdersManMarkingLimitationsTitle: string;
  seniorOtherOrdersManMarkingLoading: string;
  ...
  seniorOtherOrdersManMarkingBestRejectedPair: string;
  seniorOtherOrdersManMarkingPositiveResult: string;
  seniorOtherOrdersManMarkingNeutralResult: string;
  seniorOtherOrdersManMarkingNegativeResult: string;
  seniorOtherOrdersManMarkingRecommendationCaveat: string;
  seniorOtherOrdersManMarkingNoRecommendationCaveat: string;
  seniorOtherOrdersManMarkingRoleCentralDefender: string;
  seniorOtherOrdersManMarkingRoleWingback: string;
  seniorOtherOrdersManMarkingRoleInnerMidfielder: string;
  ...
  seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: string;
  seniorOtherOrdersManMarkingSpecialty: string;
  seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: string;
  seniorOtherOrdersManMarkingAdjustedTargetStrength: string;
  seniorOtherOrdersManMarkingTargetChosenAsPair: string;
  seniorOtherOrdersManMarkingMarkerSummary: string;
  seniorOtherOrdersManMarkingMarkerSpecialtyEffect: string;
  seniorOtherOrdersManMarkingTargetLoss: string;
  seniorOtherOrdersManMarkingTargetRetained: string;
  seniorOtherOrdersManMarkingMarkerPenalty: string;
  ...
  seniorOtherOrdersManMarkingAdjustedStrength: string;
  seniorOtherOrdersManMarkingNormalRoleValue: string;
  seniorOtherOrdersManMarkingMarkerPlayerUnresolved: string;
  seniorOtherOrdersManMarkingMarkerDefendingUnavailable: string;
  seniorOtherOrdersManMarkingMarkerDefendingInvalid: string;
  seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: string;
  seniorOtherOrdersManMarkingMarkerNormalValueInvalid: string;
  seniorOtherOrdersNewPositionLabel: string;
  seniorOtherOrdersNoPositionChange: string;
  seniorOtherOrdersNewBehaviourLabel: string;
  seniorOtherOrdersNoBehaviourChange: string;
  seniorOtherOrdersBehaviourNormal: string;
  seniorOtherOrdersBehaviourOffensive: string;
  seniorOtherOrdersBehaviourDefensive: string;
  seniorOtherOrdersBehaviourTowardsMiddle: string;
  seniorOtherOrdersBehaviourTowardsWing: string;
  seniorOtherOrdersBehaviourExtraForward: string;
  seniorOtherOrdersBehaviourExtraInnerMidfield: string;
  seniorOtherOrdersBehaviourExtraDefender: string;
  seniorOtherOrdersMoveUp: string;
  seniorOtherOrdersClear: string;
  ...
  transferMarketPastSearchesButton: string;
  transferMarketProfilesTooltip: string;
  transferMarketProfilesAriaLabel: string;
  transferMarketSaveAsProfileButton: string;
  transferMarketProfileNameLabel: string;
  transferMarketProfileNamePlaceholder: string;
  transferMarketSaveProfileTitle: string;
  transferMarketSaveProfileConfirm: string;
  transferMarketProfileNameRequired: string;
  transferMarketOverwriteProfileTitle: string;
  transferMarketOverwriteProfileBody: string;
  transferMarketOverwriteProfileConfirm: string;
  transferMarketOverwriteProfileCancel: string;
  transferMarketProfileSaved: string;
  transferMarketProfileOverwritten: string;
  transferMarketPastSearchesTitle: string;
  transferMarketPastSearchesEmpty: string;
