...
export const messagesDe: Messages = {
    ...
    youtubeWatchRelatedVideo: "Zugehöriges Video ansehen",
    youtubePlayerTitle: "YouTube-Video",
    youtubePlayerClose: "Video schließen",
    youtubePlayerMinimize: "Video minimieren",
    youtubePlayerRestore: "Video wiederherstellen",
    youtubePlayerOpenExternal: "Auf YouTube öffnen",
    youtubePlayerAdjust: "Video verschieben oder skalieren",
    youtubePlayerDoneAdjusting: "Fertig",
    ...
    clubChroniclePremiumLicenseTitle:
      "Diese Funktion erfordert die HT Alchemy Premium-Lizenz.",
    ...
    appLicenseFeatureSeniorRatingsTitle: "Ratings manuell bearbeiten",
    appLicenseFeatureSeniorRatingsDescription:
      "Spieler werden anhand von Ratings ausgewählt. Bearbeite die Ratings-Matrix manuell, um Spieler gezielt zu erzwingen oder auszuschließen und deine Aufstellung feiner abzustimmen.",
    ...
    appLicenseFeatureChronicleLikelyTrainingTitle: "Wahrscheinliches Trainingsregime",
    appLicenseFeatureChronicleLikelyTrainingDescription:
      "Leitet ab, was dieses Team trainiert, basierend auf den in trainierbaren Spielen genutzten Formationen.",
    appLicenseFeatureChronicleTrackingTitle: "Unbegrenztes Club-Chronicle-Tracking",
    appLicenseFeatureChronicleTrackingDescription:
      "Schalte zusätzliche Club-Chronicle-Tabs frei und verfolge mehr Teams pro Tab. So kannst du größere Rivalengruppen verfolgen, ohne deine Watchlist kürzen zu müssen.",
    ...
    changelog_6_7_0:
      "Fähigkeitsbasierte Spielerzuweisung für Seniorenaufstellungen.",
    changelog_6_6_0:
    ...
    settingsAutoRefreshTitle: "Automatische Aktualisierung",
    ...
    settingsSeniorPredictedRatingsTitle: "Prognostizierte Ratings",
    settingsSeniorPredictedRatingsExperimentalLabel: "Experimentell",
    settingsSeniorPredictedRatingsToggleLabel: "Prognostizierte Ratings aktivieren",
    settingsSeniorPredictedRatingsDescription: "Diese Funktion ist experimentell, weil CHPP derzeit falsche prognostizierte Spielrating-Werte zurückgibt. Aktiviere sie nur, wenn du die Funktion trotzdem hilfreich findest. Bitte erwäge, das Problem über Hattrick Staff Messages zu melden, und erwähne, dass der matchorders-Endpunkt falsche Werte zurückgibt, wenn er mit predictratings=true aufgerufen wird.",
    settingsSeniorPredictedRatingsReportLabel: "Fehlerbericht",
    settingsSeniorPredictedRatingsReportText: "Betreff: Falsche prognostizierte Ratings vom CHPP-Endpunkt matchorders\n\nHallo,\n\nder CHPP-Endpunkt matchorders scheint falsche Werte zurückzugeben, wenn prognostizierte Ratings mit predictratings=true angefordert werden.\n\nDie zurückgegebenen Sektor-Ratings entsprechen nicht den erwarteten Ratings für die ausgewählte Aufstellung, Spieleranweisungen, Taktik, Einstellung und den Spielkontext. Dadurch können CHPP-Anwendungen keine zuverlässigen prognostizierten Spielratings bereitstellen.\n\nKönntet ihr bitte die Berechnung der prognostizierten Ratings oder die Antwort des Endpunkts matchorders prüfen?\n\nVielen Dank.",
    settingsSeniorPredictedRatingsCopyReportButton: "Bericht kopieren",
    settingsSeniorPredictedRatingsReportButton: "Melden",
    settingsSeniorPredictedRatingsReportCopied: "Bericht kopiert.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Der Bericht konnte nicht kopiert werden. Bitte markiere und kopiere den Text manuell.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Vorbereiteter Fehlerbericht zu prognostizierten Ratings",
    ...
    settingsLicenseActivationSuccessTitle: "Lizenz aktiviert",
    settingsLicenseActivationSuccessBody:
      "Deine HT Alchemy Premium-Lizenz wurde für diese App-Instanz aktiviert.",
    settingsLicenseExpiringWeekTitle: "Lizenz läuft bald ab",
    settingsLicenseExpiringWeekBody:
      "Deine HT Alchemy Premium-Lizenz läuft in etwa 1 Woche ab. Kaufe jetzt ein neues Abonnement, damit die Premium-Funktionen ohne Unterbrechung aktiv bleiben.",
    settingsLicenseExpiringDayTitle: "Lizenz läuft bald ab",
    settingsLicenseExpiringDayBody:
      "Deine HT Alchemy Premium-Lizenz läuft in etwa 1 Tag ab. Kaufe jetzt ein neues Abonnement, damit die Premium-Funktionen ohne Unterbrechung aktiv bleiben.",
    settingsLicenseRenewButton: "Neues Abonnement kaufen",
    settingsLicenseLimitExceededTitle: "Lizenz herabgestuft",
    settingsLicenseLimitExceededBody:
      "Diese App-Instanz wurde auf die Free-Version herabgestuft, weil das Aktivierungslimit der Lizenz überschritten wurde.",
    settingsLicenseRevocationSuccessTitle: "Lizenz widerrufen",
    settingsLicenseRevocationSuccessBody:
      "Diese App-Instanz wurde von der aktiven Lizenz getrennt und der Premiumzugang wurde entfernt.",
    settingsLicenseNoActive: "Keine aktive Lizenz.",
    settingsLicenseLoading: "Lade Lizenzdetails…",
    settingsLicenseStatusLabel: "Aktueller Status",
    settingsLicenseStatusActive: "Aktiv",
    settingsLicenseStatusInactive: "Inaktiv",
    settingsLicenseStatusExpired: "Abgelaufen",
    settingsLicenseStatusDisabled: "Deaktiviert",
    settingsLicenseDetailStatus: "Lizenzstatus",
    settingsLicenseDetailKey: "Lizenzschlüssel",
    settingsLicenseDetailActivationLimit: "Aktivierungslimit",
    settingsLicenseDetailActivationUsage: "Aktivierungsnutzung",
    settingsLicenseDetailCreatedAt: "Erstellt am",
    settingsLicenseDetailExpiresAt: "Läuft ab am",
    settingsLicenseDetailInstanceId: "Instanz-ID",
    settingsLicenseDetailInstanceName: "Instanzname",
    settingsLicenseDetailInstanceCreatedAt: "Instanz erstellt am",
    settingsLicenseDetailStoreId: "Store-ID",
    settingsLicenseDetailOrderItemId: "Bestellpositions-ID",
    settingsLicenseDetailProductId: "Produkt-ID",
    settingsLicenseDetailProduct: "Produkt",
    settingsLicenseDetailVariantId: "Varianten-ID",
    settingsLicenseDetailVariant: "Variante",
    settingsLicenseDetailOrderId: "Bestell-ID",
    settingsLicenseDetailCustomerId: "Kunden-ID",
    settingsLicenseDetailCustomerName: "Kundenname",
    settingsLicenseDetailCustomerEmail: "Kunden-E-Mail",
    settingsLicenseNeverExpires: "Nie",
    ...
    clubChronicleRefreshTeamAttitudeTooltip: "Team-attitude-Daten aktualisieren.",
    ...
    clubChronicleRefreshStatusMatchLineupsProgress:
      "Aufstellungen {completed}/{total} (Team: {team})",
    ...
    clubChronicleHelpBulletLeague:
      "Ligaleistung: Tabelle mit Position, Punkten, Serie, Pokal, Positionsaenderung und Tordifferenz. Der Pokalwert kommt aus den Teamdetails und zeigt Keine, wenn das Team nicht mehr im Pokal ist. Klick auf eine Zeile zeigt den Vorher/Nachher-Vergleich auf Attributebene.",
    ...
    clubChronicleHelpBulletFinance:
      "Transfersaldo: Anzahl Kaeufe, Anzahl Verkaeufe und Saldo in the display currency. Klick auf eine Zeile zeigt die detaillierte Aufschluesselung.",
    ...
    clubChronicleHelpBulletTeamAttitude:
      "Team Attitude nutzt die haeufigste Formation wieder, vergleicht HatStats aus Ligaspielen mit gleicher Formation getrennt nach Heim- und Auswaertsbasis und markiert wahrscheinliche PIC-, MOTS- oder Normal-Spiele. Potenzial-Labels verwenden eine reine Ligaspiel-Baseline nahe dem venue-spezifischen normalen HatStats-Niveau.",
    ...
    clubChronicleHelpBulletWages:
      "Gehaelter: Team-Gesamtgehalt und Top-11-Gehaelter in the display currency. Klick auf eine Zeile zeigt sortierbare Spielerdetails mit Index, Alter (Jahre+Tage), Gehalt und gespeicherten Form-7-Spielbewertungen mit Wetter-Emoji.",
    ...
    clubChronicleTeamAttitudeDebugBaselineValuesLabel: "Alle HatStats-Werte",
    ...
    clubChronicleTeamAttitudeDetailsDisclaimer:
      "Die abgeleitete Einstellung ist eine heuristische Schaetzung auf Basis von HatStats-Abweichungen. Diese Tabelle zeigt die fuer die Ableitung genutzten Spiele: Spiele mit der dominantesten Formation ({formation}) und einer Spielerkonstellation, die fuer eine Ligaspiel-Aufstellung repraesentativ ist.",
    ...
    clubChronicleColumnCup: "Pokal",
    clubChronicleCupNone: "Keine",
    ...
    clubChronicleLeagueSectionTitle: "Ligaleistung und Pokal",
    ...
    teamSpiritCurrentTeamSpiritTooltip:
      "Ueberschreibe diesen Wert manuell, wenn deine Teamstimmung durch einen Spielerverkauf beeinflusst wurde. Diese Information ist nicht ueber CHPP verfuegbar.",
    teamSpiritCurrentTeamSpiritInfoAria: "Information zur aktuellen Teamstimmung",
    ...
    teamSpiritLoadingLeagueFixtures: "Ligaspielplan wird geladen...",
    teamSpiritLoadingTeamDetails: "Teamdetails werden geladen...",
    teamSpiritLoadingDetails: "Abgeschlossene Spieldetails werden geladen...",
    teamSpiritLoadingClub: "Vereinsstab wird geladen...",
    teamSpiritNoMatches: "Keine Teamstimmungsspiele fuer diese Saison gefunden.",
    teamSpiritLoadArchiveFailed: "Teamstimmungsspiele konnten nicht geladen werden.",
    teamSpiritLoadLeagueFixturesFailed: "Ligaspielplan konnte nicht geladen werden.",
    teamSpiritLoadTeamDetailsFailed: "Teamdetails konnten nicht geladen werden.",
    teamSpiritLoadClubFailed: "Vereinsstab konnte nicht geladen werden.",
    teamSpiritLoadMatchDetailsFailed: "Spieldetails konnten nicht geladen werden",
    teamSpiritSeasonUnknown:
      "Die aktuelle Saison konnte nicht bestimmt werden. Teamstimmungsspiele koennen noch nicht geladen werden.",
    teamSpiritCoachLeadershipDefaultWarning:
      "Trainer-Fuehrung konnte nicht bestimmt werden, daher wird weak verwendet.",
    teamSpiritFetchedPsychologistLevel: "Geladene Sportpsychologenstufe: {{level}}.",
    ...
    teamSpiritBefore: "Vorher",
    teamSpiritBeforeMatch: "TS vor dem Spiel",
    teamSpiritBeforeMatchTooltip:
      "Ueberschreibe diesen Wert manuell, wenn deine Teamstimmung durch einen Spielerverkauf beeinflusst wurde. Diese Information ist nicht ueber CHPP verfuegbar.",
    teamSpiritBeforeMatchInfoAria: "Information zu TS vor dem Spiel",
    teamSpiritCalculatedSeasonStart:
      "Die berechnete Start-Teamstimmung der Saison ist {{value}} ({{level}}), basierend auf Sportpsychologe-Stufe {{psychologistLevel}}.",
    teamSpiritMidfield: "Mittelfeld",
    teamSpiritMidfieldIfYou: "wenn du ...",
    teamSpiritMidfieldPerformance: "Mittelfeldleistung",
    teamSpiritAfterMatch: "TS nach dem Spiel",
    teamSpiritRecoveryBeforeNext: "Erholung bis zum naechsten TS-Spiel",
    teamSpiritDailyUpdates: "{{count}} taegliche Updates",
    teamSpiritAfterRecovery: "Nach Erholung",
    teamSpiritMissingTeamAttitude: "Team-Einstellung fehlt",
    teamSpiritCalculationUncertain: "Berechnung ab diesem Spiel unsicher.",
    teamSpiritCalculationUnavailable: "Nicht verfuegbar",
    teamSpiritUnavailableMatchInProgress: "Nicht verfuegbar, Spiel laeuft",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "Berechnete TS nicht verfuegbar, weil ein Spiel laeuft",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Berechnung nicht verfuegbar, weil ein Spiel laeuft.",
    ...
    seniorLineupAlgorithmAriaLabel:
      "Zuweisungsalgorithmus für die Seniorenaufstellung",
    seniorLineupAlgorithmSkills: "Fähigkeiten",
    seniorLineupAlgorithmRatings: "Bewertungen",
    ...
    seniorAiLastMatchThresholdDisabledText:
      "Ignoriere Spieler, deren letztes Spiel mehr als {{weeks}} Wochen zurückliegt.",
    ...
    seniorOtherOrdersSubstitutionsNone: "Keine geplanten Wechsel.",
    seniorOtherOrdersPenaltyTakersTitle: "Elfmeterschützen",
    seniorOtherOrdersPenaltyTakersNone: "Keine Elfmeterschützen-Reihenfolge.",
    seniorOtherOrdersCaptainTitle: "Kapitän",
    seniorOtherOrdersCoachPick: "Trainerwahl",
    seniorOtherOrdersSetPiecesTitle: "Standards",
    seniorOtherOrdersMinuteLabel: "Minute",
    seniorOtherOrdersPlayerInLabel: "Rein",
    seniorOtherOrdersPlayerOutLabel: "Raus",
    seniorOtherOrdersOrderTypeLabel: "Anweisung",
    seniorOtherOrdersReplaceLabel: "Ersetzen",
    seniorOtherOrdersSwapLabel: "Tauschen",
    seniorOtherOrdersRepositionLabel: "Umpositionieren",
    seniorOtherOrdersUnknownOrderLabel: "Unbekannt",
    seniorOtherOrdersSpecialOrderLabel: "Spezial",
    seniorOtherOrdersConditionsLabel: "Bedingungen",
    seniorOtherOrdersCardLabel: "Karten",
    seniorOtherOrdersStandingLabel: "Spielstand",
    ...
    seniorOtherOrdersNoStartingXiPlayers: "Keine Startelfspieler verfuegbar",
    seniorOtherOrdersNoBenchPlayers: "Keine Bankspieler verfuegbar",
    ...
    seniorOtherOrdersDeprecatedRedCardCriterion:
      "Veraltetes Rote-Karten-Kriterium",
    ...
    seniorOtherOrdersManMarkingNoOpponent:
      "Waehle ein Spiel, bevor du ein Manndeckungsziel auswaehlst.",
    seniorOtherOrdersOpponentPlayersLoading: "Gegnerische Spieler werden geladen...",
    ...
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Deckungsspieler wählen",
    ...
    seniorOtherOrdersManMarkingAlternativesTitle: "Geprüfte Alternativen",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Zielbewertung",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Manndeckerbewertung",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Paarbewertung",
    seniorOtherOrdersManMarkingLimitationsTitle: "Wichtige Einschränkungen",
    seniorOtherOrdersManMarkingLoading: "Manndeckungsbewertung wird vorbereitet...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Aktuell ist kein Manndecker ausgewählt.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Aktuell ist kein Ziel ausgewählt.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "Der ausgewählte Spieler spielt derzeit nicht auf einer gültigen Manndeckungsposition.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} erschien in {{count}} von {{total}} analysierten Spielen ({{percent}}) als {{role}} und liegt damit unter der erforderlichen Konstanzschwelle von {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} spielte überwiegend als {{role}}; das ist keine zulässige Zielposition für Manndeckung.",
    ...
    seniorOtherOrdersManMarkingTargetRoleUnknown: "Die erwartete markierbare Position des Ziels konnte aus der analysierten Historie nicht bestimmt werden.",
    seniorOtherOrdersManMarkingNoHistory: "Für diesen Spielkontext war keine nutzbare Gegnerhistorie verfügbar.",
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Kein bewertetes Paar hatte einen positiven geschätzten Nettonutzen.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Bestes bewertetes nicht positives Paar:",
    seniorOtherOrdersManMarkingPositiveResult: "Dieses Paar ist im Manndeckungsmodell der App positiv.",
    seniorOtherOrdersManMarkingNeutralResult: "Dieses Paar ist im Manndeckungsmodell der App ungefähr neutral.",
    seniorOtherOrdersManMarkingNegativeResult: "Dieses Paar ist im Manndeckungsmodell der App negativ.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Diese Bewertung setzt voraus, dass der Gegner den identifizierten Spieler auf der erwarteten Position einsetzt. Sie basiert auf früheren Aufstellungen und geschätzten Spielerdaten. Der Gegner kann einen anderen Spieler, eine andere Formation, Position, Auswechslung oder Taktik verwenden; dann kann die Manndeckung weniger wirksam sein oder nicht wie erwartet greifen. Gegnerfähigkeiten und angezeigte Effekte sind Schätzungen, keine garantierten Match-Engine-Ergebnisse. Hattrick Alchemy kann unerwartete Gegnerentscheidungen nicht vorhersagen und übernimmt keine Verantwortung für das daraus entstehende Spielergebnis. Prüfe die endgültige Anweisung vor dem Senden.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Diese Schlussfolgerung beruht nur auf verfügbaren historischen und geschätzten Daten. Wenn kein Ziel erkannt wird, beweist das nicht, dass kein geeignetes Ziel existiert; eine nicht positive Schätzung garantiert nicht, dass Manndeckung gegen die tatsächliche künftige Aufstellung scheitern würde. Der Gegner kann anders handeln als in früheren Spielen.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "Innenverteidiger",
    seniorOtherOrdersManMarkingRoleWingback: "Außenverteidiger",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "innerer Mittelfeldspieler",
    seniorOtherOrdersManMarkingRoleForward: "Stürmer",
    seniorOtherOrdersManMarkingRoleWinger: "Flügelspieler",
    seniorOtherOrdersManMarkingRecommendationSummary: "Dieses Paar hatte unter {{count}} gültig geprüften Paaren den höchsten positiven geschätzten Nettovorteil.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Ausgewähltes Paar",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Diese Analyse gilt für den aktuell ausgewählten Deckungsspieler und das aktuelle Ziel.",
    seniorOtherOrdersManMarkingTargetConsistency: "Erwartete Rolle: {{role}}. Der Spieler erschien dort in {{count}} von {{total}} analysierten Spielen ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Geschätzte rohe Hauptfähigkeit",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Geschätzte effektive Hauptfähigkeit",
    seniorOtherOrdersManMarkingSpecialty: "Spezialität",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Ziel-Vergleichsmultiplikator",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Angepasste Ziel-Vergleichsstärke",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "Das Ziel wird als Teil des besten Gesamtpaars gewählt, nicht zwingend weil es einzeln die höchste Schätzung hat.",
    seniorOtherOrdersManMarkingMarkerSummary: "Der Manndecker spielt als {{role}} mit effektiver Verteidigung {{defending}}, angepasster Markierungsstärke {{adjusted}} und geschätztem normalem Positionswert {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Spezialität: {{specialty}}. Manndeckungs-Vergleichsmultiplikator: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Neutralisierter geschätzter Hauptskill-Beitrag des Ziels",
    seniorOtherOrdersManMarkingTargetRetained: "Verbleibender geschätzter Hauptskill-Beitrag des Ziels",
    seniorOtherOrdersManMarkingMarkerPenalty: "Verringerung des normalen Positionsbeitrags des Deckungsspielers",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Da {{markerRole}} und {{targetRole}} ein nahes Rollenpaar bilden, wird geschätzt, dass Manndeckung den normalen Positionsbeitrag des Deckungsspielers um {{penalty}} reduziert.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Da {{markerRole}} und {{targetRole}} kein nahes Rollenpaar bilden, wird geschätzt, dass Manndeckung den normalen Positionsbeitrag des Deckungsspielers um {{penalty}} reduziert.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Nächstbester Nettovorteil: {{net}}. Das ist {{difference}} niedriger als beim empfohlenen Paar.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Nächstbester Nettovorteil: {{net}}. Das ist praktisch gleich wie beim empfohlenen Paar.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Nächstbester Nettovorteil: {{net}}. Das ist {{difference}} höher als beim empfohlenen Paar.",
    seniorOtherOrdersManMarkingValidTargets: "Gültige Zielschätzungen sind verfügbar.",
    seniorOtherOrdersManMarkingValidMarkers: "Gültige Manndeckerkandidaten sind verfügbar.",
    seniorOtherOrdersManMarkingEffectiveDefending: "effektive Verteidigung",
    seniorOtherOrdersManMarkingAdjustedStrength: "angepasste Stärke",
    seniorOtherOrdersManMarkingNormalRoleValue: "normaler Rollenwert",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} konnte nicht als eigener Spieler aufgelöst werden.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "Für {{player}} ist keine effektive Verteidigung verfügbar.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} hat eine ungültige oder nicht positive effektive Verteidigung.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "Für {{player}} ist kein normaler Positionswert verfügbar.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} hat einen ungültigen oder nicht positiven normalen Positionswert.",
    ...
    seniorOtherOrdersBehaviourOffensive: "Offensiv",
    seniorOtherOrdersBehaviourDefensive: "Defensiv",
    seniorOtherOrdersBehaviourTowardsMiddle: "Zur Mitte",
    seniorOtherOrdersBehaviourTowardsWing: "Zum Fluegel",
    seniorOtherOrdersBehaviourExtraForward: "Extra-Stuermer",
    seniorOtherOrdersBehaviourExtraInnerMidfield: "Extra-Innenmittelfeld",
    seniorOtherOrdersBehaviourExtraDefender: "Extra-Verteidiger",
    ...
    analyzeOpponentMatchColumn: "Spiel",
    analyzeOpponentResultColumn: "Ergebnis",
    analyzeOpponentResultWin: "Sieg",
    analyzeOpponentResultLoss: "Niederlage",
    analyzeOpponentResultDraw: "Unentschieden",
    ...
    analyzeOpponentMatchFallback: "Spiel {{matchId}}",
    ...
    seniorEnterPlayerIdButtonLabel: "Spieler-ID eingeben",
    seniorEnterPlayerIdTooltip:
      "Spielerdetails für einen Spieler anzeigen, der nicht in deinem Team ist.",
    seniorEnterPlayerIdModalTitle: "Spieler-ID eingeben",
    seniorEnterPlayerIdInputLabel: "Spieler-ID",
    seniorEnterPlayerIdPlaceholder: "Numerische Spieler-ID eingeben",
    seniorEnterPlayerIdSubmitLabel: "Spieler laden",
    seniorEnterPlayerIdLoadingLabel: "Spieler wird geladen...",
    seniorEnterPlayerIdInvalid: "Gib eine gueltige numerische Spieler-ID ein.",
    seniorEnterPlayerIdNotFound: "Spieler-ID {{playerId}} wurde nicht gefunden.",
    seniorObservedExternalPlayerNotice: "Dieser Spieler ist nicht in deinem Team.",
    seniorObservedExternalPlayerClearLabel: "Beobachteten Spieler entfernen",
    ...
    seniorTransferSearchPriceRangeLabel: "Preis ({{currency}})",
    transferSearchHtmsPotentialRangeLabel: "HTMS-Potenzial",
    transferSearchHtmsPotentialMinLabel: "Min. HTMS-Potenzial",
    transferSearchHtmsPotentialMaxLabel: "Max. HTMS-Potenzial",
    transferSearchNativeCountryLabel: "Herkunftsland",
    transferMarketPastSearchesButton: "Fruehere Suchen",
    transferMarketProfilesTooltip: "Suchprofile auflisten",
    transferMarketProfilesAriaLabel: "Suchprofile auflisten",
    transferMarketSaveAsProfileButton: "Als Profil speichern",
    transferMarketProfileNameLabel: "Profilname",
    transferMarketProfileNamePlaceholder: "z. B. Torwart-Talente",
    transferMarketSaveProfileTitle: "Suchprofil speichern",
    transferMarketSaveProfileConfirm: "Profil speichern",
    transferMarketProfileNameRequired: "Gib einen Profilnamen ein.",
    transferMarketOverwriteProfileTitle: "Profil ueberschreiben?",
    transferMarketOverwriteProfileBody: "Ein Profil namens {{name}} existiert bereits. Ueberschreiben?",
    transferMarketOverwriteProfileConfirm: "Ueberschreiben",
    transferMarketOverwriteProfileCancel: "Zurueck",
    transferMarketProfileSaved: "Profil gespeichert.",
    transferMarketProfileOverwritten: "Profil ueberschrieben.",
    transferMarketPastSearchesTitle: "Fruehere Suchen",
    transferMarketPastSearchesEmpty: "Keine frueheren Suchen.",
    ...
    seniorTransferListedIndicatorLabel: "Transfergelistet",
    seniorTransferListedNoBidsYet: "Noch keine Gebote",
    seniorTransferSearchSellerLabel: "Verkaeufer",
    seniorTransferSearchBidAmountLabel: "Gebot ({{currency}})",
    seniorTransferSearchMaxBidAmountLabel: "Maximalgebot ({{currency}})",
    ...
    transferSearchTableWageFootnote: "* enthaelt den Auslaenderzuschlag relativ zu deinem Team.",
    notificationDebugTransferWageContext:
      "Debug: gewaehlte Teamliga {{selectedLeagueId}}",
    notificationDebugTransferWagePlayer:
      "Debug: {{name}} Heimatliga {{nativeLeagueId}}, im Ausland {{isAbroad}}, fremd {{foreign}}, Gehalt {{salarySek}}, angepasst {{adjustedSalarySek}}",
    ...
    lineupEmptySlotRecommendationsHint:
      "Klicke auf leere Positionen für Spielerempfehlungen",
    clearSlot: "Leeren",
    ...
    seniorFoxtrickSimulationPremiumTooltip:
      "Kaufe eine HT Alchemy Premium-Lizenz, um in den Senior-Spielerdetails Skills, Alter, Gehalt und TSI zu bearbeiten.",
    ...
    seniorFoxtrickSimulationWageLabel: "Gehalt ({{currency}})",
    ...
    lineupSlotLeftWingBack: "Linker Außenverteidiger",
    lineupSlotRightWingBack: "Rechter Außenverteidiger",
    lineupSlotLeftCentralDefender: "Linker Innenverteidiger",
    lineupSlotCentralDefender: "Innenverteidiger",
    lineupSlotRightCentralDefender: "Rechter Innenverteidiger",
    lineupSlotLeftWinger: "Linker Flügel",
    lineupSlotRightWinger: "Rechter Flügel",
    lineupSlotLeftInnerMidfield: "Linkes zentrales Mittelfeld",
    lineupSlotCentralInnerMidfield: "Zentrales Mittelfeld",
    lineupSlotRightInnerMidfield: "Rechtes zentrales Mittelfeld",
    lineupSlotLeftForward: "Linker Stürmer",
    lineupSlotCentralForward: "Mittelstürmer",
    lineupSlotRightForward: "Rechter Stürmer",
    lineupSlotBenchKeeper: "Ersatz Torwart",
    lineupSlotBenchCentralDefender: "Ersatz Innenverteidiger",
    lineupSlotBenchWingBack: "Ersatz Außenverteidiger",
    lineupSlotBenchInnerMidfield: "Ersatz zentrales Mittelfeld",
    lineupSlotBenchForward: "Ersatz Stürmer",
    lineupSlotBenchWinger: "Ersatz Flügel",
    lineupSlotBenchExtra: "Ersatz Extra",
