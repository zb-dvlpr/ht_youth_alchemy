...
export const messagesDe: Messages = {
    ...
    seniorTransferSearchPriceRangeLabel: "Preis (display currency)",
    ...
    seniorTransferSearchBidAmountLabel: "Gebot (display currency)",
    seniorTransferSearchMaxBidAmountLabel: "Maximalgebot (display currency)",
    ...
    seniorFoxtrickSimulationWageLabel: "Gehalt (display currency)",
