...
export const messagesEn: Messages = {
    ...
    youtubeWatchRelatedVideo: "Watch related video",
    youtubePlayerTitle: "YouTube video",
    youtubePlayerClose: "Close video",
    youtubePlayerMinimize: "Minimize video",
    youtubePlayerRestore: "Restore video",
    youtubePlayerOpenExternal: "Open on YouTube",
    youtubePlayerAdjust: "Move or resize video",
    ...
    settingsAutoRefreshTitle: "Auto refresh",
    settingsYouth: "Youth",
    ...
    settingsSeniorPredictedRatingsTitle: "Predicted ratings",
    settingsSeniorPredictedRatingsExperimentalLabel: "Experimental",
    settingsSeniorPredictedRatingsToggleLabel: "Enable predicted ratings",
    settingsSeniorPredictedRatingsDescription: "This feature is experimental because CHPP currently returns incorrect predicted match-rating values. Enable it only if you still find the feature useful. Please consider reporting the issue through Hattrick Staff Messages and mention that the matchorders endpoint returns incorrect values when called with predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Bug report",
    settingsSeniorPredictedRatingsReportText: "Subject: Incorrect predicted ratings returned by the CHPP matchorders endpoint\n\nHello,\n\nThe CHPP matchorders endpoint appears to return incorrect values when predicted ratings are requested with predictratings=true.\n\nThe returned sector ratings do not correspond to the expected ratings for the selected lineup, player orders, tactic, match attitude, and match context. This prevents CHPP applications from providing reliable predicted match ratings.\n\nCould you please investigate the predicted-ratings calculation or the response returned by the matchorders endpoint?\n\nThank you.",
    settingsSeniorPredictedRatingsCopyReportButton: "Copy report",
    settingsSeniorPredictedRatingsReportButton: "Report",
    settingsSeniorPredictedRatingsReportCopied: "Report copied.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Could not copy the report. Please select and copy the text manually.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Prepared predicted-ratings bug report",
    ...
    teamScoutInferredTrainingLabel: "Inferred training: {{training}}",
    teamScoutDataMatchesLabel: "Data: {{count}} matches",
    ...
    teamSpiritLoadingLeagueFixtures: "Loading league fixtures...",
    teamSpiritLoadingTeamDetails: "Loading team details...",
    ...
    teamSpiritLoadLeagueFixturesFailed: "Could not load league fixtures.",
    teamSpiritLoadTeamDetailsFailed: "Could not load team details.",
    ...
    teamSpiritCalculatedSeasonStart:
      "The calculated starting team spirit for the season is {{value}} ({{level}}), based on sports psychologist level {{psychologistLevel}}.",
