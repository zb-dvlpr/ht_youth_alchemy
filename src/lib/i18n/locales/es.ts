...
export const messagesEs: Messages = {
    ...
    settingsSeniorPredictedRatingsDescription: "Esta función es experimental porque CHPP actualmente devuelve valores incorrectos de calificaciones previstas de partido. Actívala solo si aun así te resulta útil. Considera informar del problema mediante Hattrick Staff Messages y mencionar que el endpoint matchorders devuelve valores incorrectos cuando se llama con predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Informe de error",
    settingsSeniorPredictedRatingsReportText: "Asunto: Calificaciones previstas incorrectas devueltas por el endpoint CHPP matchorders\n\nHola,\n\nEl endpoint CHPP matchorders parece devolver valores incorrectos cuando se solicitan calificaciones previstas usando predictratings=true.\n\nLas calificaciones por sector devueltas no corresponden a las calificaciones esperadas para la alineación, órdenes de jugadores, táctica, actitud de partido y contexto de partido seleccionados. Esto impide que las aplicaciones CHPP proporcionen calificaciones previstas de partido fiables.\n\n¿Podrían investigar el cálculo de las calificaciones previstas o la respuesta devuelta por el endpoint matchorders?\n\nGracias.",
    settingsSeniorPredictedRatingsCopyReportButton: "Copiar informe",
    settingsSeniorPredictedRatingsReportButton: "Informar",
    settingsSeniorPredictedRatingsReportCopied: "Informe copiado.",
    settingsSeniorPredictedRatingsReportCopyFailed: "No se pudo copiar el informe. Selecciona y copia el texto manualmente.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Informe de error preparado sobre calificaciones previstas",
