...
export const messagesEs: Messages = {
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Se encontraron marcadores y objetivos válidos, pero todas las parejas evaluadas tenían beneficio neto estimado cero o negativo.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Pareja evaluada menos desfavorable:",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "El cálculo siguiente se aplica a la pareja seleccionada actualmente.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Contribución afectada eliminada",
    seniorOtherOrdersManMarkingTargetRetained: "Contribución afectada retenida",
    seniorOtherOrdersManMarkingMarkerPenalty: "Penalización propia del marcador",
