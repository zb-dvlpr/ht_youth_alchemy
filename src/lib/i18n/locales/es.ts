...
export const messagesEs: Messages = {
    ...
    helpMenuYouTubeChannel: "Canal de YouTube",
    youtubeWatchRelatedVideo: "Ver el vídeo relacionado",
    youtubePlayerTitle: "Vídeo de YouTube",
    youtubePlayerClose: "Cerrar vídeo",
    youtubePlayerMinimize: "Minimizar vídeo",
    youtubePlayerRestore: "Restaurar vídeo",
    youtubePlayerOpenExternal: "Abrir en YouTube",
    youtubePlayerAdjust: "Mover o cambiar el tamaño del vídeo",
    youtubePlayerDoneAdjusting: "Listo",
    youtubePlayerAdjustHint:
      "Arrastra para mover. Pellizca para cambiar el tamaño.",
    youtubePlayerResize: "Cambiar el tamaño del vídeo",
    youtubeAppOverviewVideoOne: "Ver el vídeo general de Hattrick Alchemy 1",
    youtubeAppOverviewVideoTwo: "Ver el vídeo general de Hattrick Alchemy 2",
    youtubeSeniorSquadOptimizationVideo:
      "Ver el vídeo de optimización de la plantilla senior",
    youtubeSeniorEditSkillsAgeWageTsiVideo:
      "Ver el vídeo de Editar habilidades, edad, salario y TSI",
    ...
    chppPermissionSelectionTitle: "Elegir permisos de CHPP",
    chppPermissionSelectionIntro:
      "El acceso principal al equipo juvenil se solicitará automáticamente. Puedes elegir qué permisos opcionales de escritura quieres conceder. Puedes volver a conectarte más adelante para cambiarlos.",
    chppPermissionPlaceBidLabel: "Realizar puja",
    chppPermissionPlaceBidDescription:
      "Te permite pujar por jugadores del mercado de transferencias, por ejemplo mediante Buscar jugadores similares o Estimar valor del jugador.",
    chppPermissionSetMatchOrderLabel: "Establecer órdenes de partido",
    chppPermissionSetMatchOrderDescription:
      "Te permite enviar alineaciones a Hattrick.",
    chppPermissionSetTrainingLabel: "Establecer entrenamiento",
    chppPermissionSetTrainingDescription:
      "Te permite cambiar el régimen de entrenamiento del equipo sénior.",
    chppMissingPlaceBidTooltip:
      "Para usar esta función, el token CHPP debe haberse obtenido con el permiso Realizar puja.",
    chppMissingSetMatchOrderTooltip:
      "Para usar esta función, el token CHPP necesita el permiso Establecer órdenes de partido.",
    chppMissingSetTrainingTooltip:
      "Para usar esta función, el token CHPP necesita el permiso Establecer entrenamiento.",
    ...
    changelog_9_1_0:
      "Se implementaron cálculos de habilidad inferida para jugadores sénior y resultados de búsqueda de transferencias",
    changelog_9_0_0:
      "Se añadió la posibilidad de instalar Hattrick Alchemy como una aplicación independiente.",
    changelog_8_3_0: "Se añadieron tutoriales integrados en la aplicación.",
    changelog_8_2_0: "Se ha mejorado el algoritmo de marcaje individual de la alineación sénior para tener en cuenta las habilidades efectivas, las especialidades de los jugadores, las penalizaciones por posición y las habilidades principales estimadas del rival.",
    ...
    settingsAutoRefreshTitle: "Actualización automática",
    ...
    settingsSeniorPredictedRatingsTitle: "Calificaciones previstas",
    settingsSeniorPredictedRatingsExperimentalLabel: "Experimental",
    settingsSeniorPredictedRatingsToggleLabel: "Activar calificaciones previstas",
    ...
    settingsLayoutTitle: "Diseño de la app",
    settingsLayoutDescription:
      "Automático usa señales de ventana y dispositivo. Móvil usa siempre el diseño móvil de HT Alchemy, y Escritorio usa siempre su diseño de escritorio. Este ajuste no puede cambiar la preferencia Sitio de escritorio del navegador.",
    settingsLayoutSelectLabel: "Preferencia de diseño",
    settingsLayoutAuto: "Automático",
    settingsLayoutMobile: "Móvil",
    settingsLayoutDesktop: "Escritorio",
    ...
    settingsDebugSupporterOverrideHint:
      "Solo desarrollo. Elige el nivel Supporter que debe simular la app.",
    settingsDebugSupporterTierNone: "Ninguno",
    settingsDebugSupporterTierSilver: "Plata",
    settingsDebugSupporterTierGold: "Oro",
    settingsDebugSupporterTierPlatinum: "Platino",
    settingsDebugSupporterTierDiamond: "Diamante",
    settingsDebugTeamSpiritStillInCupLabel: "Simular que sigue en copa principal",
    settingsDebugTeamSpiritStillInCupHint:
      "Muestra un partido de copa actual simulado seguido de marcadores semanales hasta el final de la temporada.",
    ...
    clubChronicleHelpBulletTeamAttitude:
      "Team Attitude reutiliza la formacion mas comun, compara HatStats de liga con la misma formacion con bases separadas de local y visitante, y marca partidos probablemente PIC, MOTS o normales. Las etiquetas potenciales usan una plantilla base solo de liga cercana al nivel normal de HatStats para ese campo.",
    ...
    clubChronicleTeamAttitudeDebugBaselineValuesLabel: "Todos los valores HatStats",
    ...
    clubChronicleTeamAttitudeDetailsDisclaimer:
      "La actitud inferida es una estimacion heuristica basada en desviaciones de HatStats. Esta tabla muestra los partidos usados para la inferencia: partidos jugados con la formacion mas dominante ({formation}) y una constelacion de jugadores representativa de una alineacion de liga.",
    ...
    teamScoutDetailInfoButtonLabel: "Información de ojeo del equipo",
    teamScoutInferredTrainingLabel: "Entrenamiento inferido: {{training}}",
    teamScoutDataMatchesLabel: "Datos: {{count}} partidos",
    teamScoutDataMatchLabel: "Datos: {{count}} partido",
    ...
    seniorMatchesUpcomingTab: "Próximos partidos",
    seniorMatchesTeamSpiritTab: "Espíritu de equipo",
    teamSpiritCurrentTeamSpirit: "Espíritu de equipo actual",
    ...
    teamSpiritCurrentTeamSpiritInfoAria: "Información del espíritu de equipo actual",
    teamSpiritCalculatedCurrent: "Calculado: {{value}}",
    teamSpiritCalculatedUnavailable: "Valor calculado no disponible",
    teamSpiritSelectedTeamNotInMatch:
      "El equipo senior seleccionado no aparece en estos detalles del partido.",
    teamSpiritManuallyOverridden: "Sobrescrito manualmente",
    teamSpiritReset: "Restablecer",
    teamSpiritCoachLeadership: "Liderazgo del entrenador",
    teamSpiritCoachLeadershipActual: "Detectado: {{leadership}}",
    teamSpiritCoachLeadershipTooltip:
      "Sobrescribe este valor para ver como otro nivel de liderazgo del entrenador afectaria el espiritu de equipo.",
    teamSpiritCoachLeadershipInfoAria: "Acerca de sobrescribir liderazgo del entrenador",
    teamSpiritSportsPsychologist: "Psicólogo deportivo",
    teamSpiritSportsPsychologistLevel: "Nivel del psicólogo deportivo",
    ...
    teamSpiritLoadingLeagueFixtures: "Cargando calendario de liga...",
    teamSpiritLoadingTeamDetails: "Cargando detalles del equipo...",
    teamSpiritLoadingDetails: "Cargando detalles de partidos completados...",
    teamSpiritLoadingClub: "Cargando personal del club...",
    teamSpiritNoMatches: "No se encontraron partidos de espiritu de equipo esta temporada.",
    teamSpiritLoadArchiveFailed: "No se pudieron cargar los partidos de espiritu de equipo.",
    teamSpiritLoadLeagueFixturesFailed: "No se pudo cargar el calendario de liga.",
    teamSpiritLoadTeamDetailsFailed: "No se pudieron cargar los detalles del equipo.",
    teamSpiritLoadClubFailed: "No se pudo cargar el personal del club.",
    teamSpiritLoadMatchDetailsFailed: "No se pudieron cargar los detalles del partido",
    teamSpiritSeasonUnknown:
      "No se pudo determinar la temporada actual. Aun no se pueden cargar los partidos de espiritu de equipo.",
    teamSpiritCoachLeadershipDefaultWarning:
      "No se pudo determinar el liderazgo del entrenador, se usa weak.",
    teamSpiritFetchedPsychologistLevel: "Nivel de psicologo deportivo cargado: {{level}}.",
    teamSpiritLeagueMatch: "Partido de liga",
    teamSpiritMainCupMatch: "Partido de copa principal",
    teamSpiritMainCupPlaceholder: "Partido marcador de copa principal",
    teamSpiritMainCupPlaceholderExplanation:
      "Este partido de copa hipotetico se muestra solo mientras tu equipo siga en la copa principal. Desaparecera tras la eliminacion.",
    teamSpiritDebugMainCupMatch: "Partido actual simulado de copa principal",
    teamSpiritAttitude: "Actitud",
    teamSpiritAttitudeUsed: "Actitud usada",
    teamSpiritAttitudeToBeUsed: "Actitud a usar",
    ...
    teamSpiritCalculatedSeasonStart:
      "El espíritu de equipo inicial calculado para la temporada es {{value}} ({{level}}), basado en el nivel de psicólogo deportivo {{psychologistLevel}}.",
    teamSpiritMidfield: "Mediocampo",
    teamSpiritMidfieldIfYou: "si juegas ...",
    teamSpiritMidfieldPerformance: "rendimiento de mediocampo",
    teamSpiritAfterMatch: "TS después del partido",
    teamSpiritRecoveryBeforeNext: "Recuperacion antes del proximo partido TS",
    teamSpiritDailyUpdates: "{{count}} actualizaciones diarias",
    teamSpiritAfterRecovery: "Despues de recuperacion",
    teamSpiritMissingTeamAttitude: "Falta actitud del equipo",
    teamSpiritCalculationUncertain: "Calculo incierto desde este partido.",
    teamSpiritCalculationUnavailable: "No disponible",
    teamSpiritUnavailableMatchInProgress: "No disponible mientras el partido esta en curso",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "TS calculado no disponible porque hay un partido en curso",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Calculo no disponible porque hay un partido en curso.",
    ...
    optimizeRevealUnavailableTitle: "Revelación no disponible",
    ...
    seniorOtherOrdersStyleUnavailable: "Le style de jeu necessite un asistente tactico et un type de entrenador connu.",
    ...
    seniorOtherOrdersTacticalAssistantDetected:
      "Asistente tactico nivel {{level}} detectado. Funciones de asistente tactico disponibles.",
    seniorOtherOrdersTacticalAssistantSimulated:
      "Simulacion dev: asistente tactico nivel {{level}} activo. Funciones de asistente tactico disponibles.",
    seniorOtherOrdersTacticalAssistantNone:
      "No se detecto asistente tactico. Se aplica el limite estandar de ordenes.",
    seniorOtherOrdersTacticalAssistantUnknownLevel:
      "Asistente tactico detectado, pero el nivel es desconocido. Se aplica el limite estandar hasta actualizar los datos del staff.",
    seniorOtherOrdersDevSimulateTacticalAssistant:
      "Dev: simular asistente tactico",
    ...
    seniorOtherOrdersNoStartingXiPlayers: "No hay titulares disponibles",
    seniorOtherOrdersNoBenchPlayers: "No hay suplentes disponibles",
    ...
    seniorOtherOrdersDeprecatedRedCardCriterion:
      "Criterio de tarjeta roja obsoleto",
    ...
    seniorOtherOrdersResetManMarkingRecommendation: "Restablecer el marcaje al hombre a la recomendación del algoritmo",
    seniorOtherOrdersMarkerLabel: "Candidatos marcadores elegibles",
    seniorOtherOrdersTargetLabel: "Candidatos objetivo elegibles",
    seniorOtherOrdersOpponentIdPlaceholder: "ID joueur adverse",
    seniorOtherOrdersManMarkingNoOpponent:
      "Elige un partido antes de seleccionar un objetivo de marcaje.",
    seniorOtherOrdersOpponentPlayersLoading: "Cargando jugadores rivales...",
    ...
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Elegir marcador",
    seniorOtherOrdersManMarkingTargetPlaceholder: "Elegir objetivo",
    seniorOtherOrdersUnknownOpponentPlayer: "Jugador {{playerId}}",
    seniorOtherOrdersManMarkingExplanationTitle: "Explicación del marcaje individual",
    seniorOtherOrdersManMarkingRecommendationTitle: "Recomendación",
    seniorOtherOrdersManMarkingSourceRecommended: "Recomendación del algoritmo",
    seniorOtherOrdersManMarkingSourceNoRecommendation: "Sin recomendación",
    seniorOtherOrdersManMarkingSourceManual: "Selección manual",
    seniorOtherOrdersManMarkingSourceLoaded: "Orden cargada",
    seniorOtherOrdersManMarkingSourceModifiedRecommendation:
      "Cambiado respecto a la recomendación del algoritmo",
    seniorOtherOrdersManMarkingSourceModifiedLoaded: "Orden cargada cambiada",
    seniorOtherOrdersManMarkingWhyTargetTitle: "Por qué este objetivo",
    seniorOtherOrdersManMarkingWhyMarkerTitle: "Por qué este marcador",
    seniorOtherOrdersManMarkingExpectedEffectTitle: "Efecto esperado en el partido",
    seniorOtherOrdersManMarkingAlternativesTitle: "Alternativas consideradas",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Evaluación del objetivo",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Evaluación del marcador",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Evaluación de la pareja",
    seniorOtherOrdersManMarkingLimitationsTitle: "Limitaciones importantes",
    seniorOtherOrdersManMarkingLoading: "Preparando evaluación de marcaje...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "No hay marcador seleccionado actualmente.",
    seniorOtherOrdersManMarkingNoTargetSelected: "No hay objetivo seleccionado actualmente.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "El jugador seleccionado no está alineado en una posición válida para marcar.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} apareció como {{role}} en {{count}} de {{total}} partidos analizados ({{percent}}), por debajo del umbral de consistencia requerido de {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} jugó principalmente como {{role}}, que no es una posición objetivo elegible para el marcaje al hombre.",
    seniorOtherOrdersManMarkingTargetAmbiguousPredominant: "{{player}} no tuvo una posición predominante única en los partidos analizados.",
    seniorOtherOrdersManMarkingTargetNotObserved: "{{player}} no fue observado en las alineaciones iniciales analizadas en {{total}} partidos analizados.",
    seniorOtherOrdersManMarkingTargetInvalidSave: "Elige un candidato objetivo elegible antes de guardar la orden de marcaje al hombre.",
    seniorOtherOrdersManMarkingTargetContextUnavailable:
      "No se pudieron verificar los candidatos objetivo para este partido. Inténtalo de nuevo antes de guardar la orden de marcaje al hombre.",
    seniorOtherOrdersManMarkingMarkerInvalidSave: "Elige un candidato marcador elegible antes de guardar la orden de marcaje al hombre.",
    seniorOtherOrdersManMarkingMarkerIneligibleCurrentPosition: "El marcador seleccionado está en el once inicial, pero no juega como defensa central, lateral o medio interno.",
    seniorOtherOrdersManMarkingMarkerNotStarting: "El marcador seleccionado no está en el once inicial actual.",
    seniorOtherOrdersManMarkingTargetRoleUnknown: "No se pudo establecer la posición marcable esperada del objetivo a partir del historial analizado.",
    seniorOtherOrdersManMarkingNoHistory: "No había historial útil del rival para este contexto de partido.",
    ...
    seniorOtherOrdersManMarkingTargetAgeUnavailable:
      "Había detalles del objetivo, pero faltaban los datos de edad.",
    seniorOtherOrdersManMarkingTargetTooOld:
      "Había detalles del objetivo, pero el jugador está fuera del rango de edad admitido por el modelo salarial.",
    seniorOtherOrdersManMarkingTargetRawEstimateUnavailable:
      "Había detalles del objetivo, pero no se pudo producir una estimación bruta de habilidad principal basada en el salario.",
    seniorOtherOrdersManMarkingTargetFormUnavailable:
      "Había detalles del objetivo, pero faltaban los datos de forma.",
    seniorOtherOrdersManMarkingTargetStaminaUnavailable:
      "Había detalles del objetivo, pero faltaban los datos de resistencia.",
    seniorOtherOrdersManMarkingTargetEffectiveUnavailable:
      "Se produjo una estimación bruta de habilidad principal, pero no pudo convertirse en una habilidad principal efectiva estimada.",
    seniorOtherOrdersManMarkingNoEligibleMarker: "No hay ningún defensa central, lateral o medio interior elegible en el once inicial.",
    seniorOtherOrdersManMarkingMarkerDataUnavailable: "Existen posiciones elegibles, pero no se pudo calcular Defensa efectiva o valor normal de posición.",
    seniorOtherOrdersManMarkingNoPositivePair: "Ninguna pareja evaluada tuvo un beneficio neto estimado positivo.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Mejor pareja evaluada no positiva:",
    seniorOtherOrdersManMarkingPositiveResult: "Esta pareja es positiva según el modelo de marcaje de la app.",
    seniorOtherOrdersManMarkingNeutralResult: "Esta pareja es aproximadamente neutral según el modelo de marcaje de la app.",
    seniorOtherOrdersManMarkingNegativeResult: "Esta pareja es negativa según el modelo de marcaje de la app.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Esta evaluación asume que el rival alinea al jugador identificado en la posición esperada. Se basa en alineaciones anteriores y datos estimados de jugadores. El rival puede usar otro jugador, formación, posición, sustitución o plan táctico; en ese caso la orden puede ser menos eficaz o no activarse como se espera. Las habilidades rivales y los efectos mostrados son estimaciones, no resultados garantizados del motor. Hattrick Alchemy no puede predecir decisiones inesperadas del rival y no acepta responsabilidad por el resultado del partido. Revisa la orden final antes de enviarla.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Esta conclusión se basa solo en datos históricos y estimados disponibles. No identificar un objetivo no demuestra que no exista uno adecuado, y una estimación no positiva no garantiza que el marcaje fallaría contra la alineación real futura del rival. El rival puede comportarse de forma distinta a partidos anteriores.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "defensa central",
    seniorOtherOrdersManMarkingRoleWingback: "lateral",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "medio interior",
    seniorOtherOrdersManMarkingRoleForward: "delantero",
    seniorOtherOrdersManMarkingRoleWinger: "extremo",
    seniorOtherOrdersManMarkingRecommendationSummary: "Esta pareja tuvo el mayor beneficio neto estimado positivo entre {{count}} parejas válidas evaluadas.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Pareja seleccionada",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Este análisis se aplica al marcador y al objetivo seleccionados actualmente.",
    seniorOtherOrdersManMarkingTargetConsistency: "Rol esperado: {{role}}. El jugador apareció ahí en {{count}} de {{total}} partidos analizados ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Habilidad principal bruta estimada",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Habilidad principal efectiva estimada",
    seniorOtherOrdersManMarkingSpecialty: "Especialidad",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Multiplicador de comparación del objetivo",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Fuerza ajustada de comparación del objetivo",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "El objetivo se selecciona como parte de la mejor pareja completa, no necesariamente porque tenga la estimación individual más alta.",
    seniorOtherOrdersManMarkingMarkerSummary: "El marcador juega como {{role}} con Defensa efectiva {{defending}}, fuerza ajustada {{adjusted}} y valor posicional normal estimado {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Especialidad: {{specialty}}. Multiplicador de comparación de marcaje: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Contribución estimada de habilidad principal del objetivo neutralizada",
    seniorOtherOrdersManMarkingTargetRetained: "Contribución estimada de habilidad principal del objetivo restante",
    seniorOtherOrdersManMarkingMarkerPenalty: "Reducción de la contribución posicional normal del marcador",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Como {{markerRole}} y {{targetRole}} forman una pareja de roles cercana, se estima que el marcaje al hombre reduce la contribución posicional normal del marcador en {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Como {{markerRole}} y {{targetRole}} no forman una pareja de roles cercana, se estima que el marcaje al hombre reduce la contribución posicional normal del marcador en {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Siguiente beneficio neto: {{net}}. Es {{difference}} menor que la pareja recomendada.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Siguiente beneficio neto: {{net}}. Es prácticamente igual que la pareja recomendada.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Siguiente beneficio neto: {{net}}. Es {{difference}} mayor que la pareja recomendada.",
    seniorOtherOrdersManMarkingValidTargets: "Hay estimaciones válidas de objetivos.",
    seniorOtherOrdersManMarkingValidMarkers: "Hay candidatos válidos de marcador.",
    seniorOtherOrdersManMarkingEffectiveDefending: "Defensa efectiva",
    seniorOtherOrdersManMarkingAdjustedStrength: "fuerza ajustada",
    seniorOtherOrdersManMarkingNormalRoleValue: "valor normal de rol",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} no pudo resolverse como jugador propio.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} no tiene valor de Defensa efectiva disponible.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} tiene Defensa efectiva inválida o no positiva.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} no tiene valor posicional normal disponible.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} tiene valor posicional normal inválido o no positivo.",
    ...
    seniorOtherOrdersBehaviourTowardsMiddle: "Hacia el centro",
    seniorOtherOrdersBehaviourTowardsWing: "Hacia la banda",
    seniorOtherOrdersBehaviourExtraForward: "Delantero extra",
    seniorOtherOrdersBehaviourExtraInnerMidfield: "Mediocentro extra",
    seniorOtherOrdersBehaviourExtraDefender: "Defensor extra",
    ...
    analyzeOpponentResultWin: "Victoria",
    ...
    transferMarketPastSearchesButton: "Busquedas anteriores",
    transferMarketProfilesTooltip: "Listar perfiles de busqueda",
    transferMarketProfilesAriaLabel: "Listar perfiles de busqueda",
    transferMarketSaveAsProfileButton: "Guardar como perfil",
    transferMarketProfileNameLabel: "Nombre del perfil",
    transferMarketProfileNamePlaceholder: "p. ej. porteros promesa",
    transferMarketSaveProfileTitle: "Guardar perfil de busqueda",
    transferMarketSaveProfileConfirm: "Guardar perfil",
    transferMarketProfileNameRequired: "Introduce un nombre de perfil.",
    transferMarketOverwriteProfileTitle: "¿Sobrescribir perfil?",
    transferMarketOverwriteProfileBody: "Ya existe un perfil llamado {{name}}. ¿Sobrescribirlo?",
    transferMarketOverwriteProfileConfirm: "Sobrescribir",
    transferMarketOverwriteProfileCancel: "Volver",
    transferMarketProfileSaved: "Perfil guardado.",
    transferMarketProfileOverwritten: "Perfil sobrescrito.",
    transferMarketPastSearchesTitle: "Busquedas anteriores",
    transferMarketPastSearchesEmpty: "No hay busquedas anteriores.",
    ...
    hattrickGoldSupporterActionRequiredTooltip:
      "Requiere Hattrick Supporter Oro, Platino o Diamante.",
    ...
    transferSearchTableSkillTradingScoreColumn: "Puntuación skill-trading",
    transferSearchTablePsicoTsiColumn: "Psico TSI",
    transferSearchTablePsicoWageColumn: "Psico wage",
    seniorTrainingInferenceTableLabel: "Límite superior inferido",
    ...
    sortCards: "Tarjetas",
    sortShirtNumber: "Número de camiseta",
    sortCustom: "--",
    ...
    seniorTrainingInferenceGroupLabel: "Límite superior de habilidad con entrenamiento",
    seniorTrainingInferenceValueLabel: "Valor de habilidad inferido",
    seniorTrainingInferenceTooltip:
      "Esto es una inferencia de habilidad como límite superior. Suponiendo que el jugador fue entrenado en {{skill}} siempre que fue elegible, acumuló el equivalente de {{weeks}} semanas de entrenamiento en posiciones de {{skill}} desde su último cumpleaños. Los valores combinan sus estimaciones de habilidad basadas en salario en ese cumpleaños con este historial posicional, usando entrenador nivel 7, 10 niveles de asistentes, 100% de intensidad y 10% de resistencia. La habilidad real del jugador puede ser menor porque se desconocen las elecciones históricas de entrenamiento de su equipo.",
    seniorTrainingInferenceZeroMinutesTooltip:
      "Esto es una inferencia de habilidad como límite superior. No se identificaron minutos elegibles de entrenamiento de {{skill}} desde el último cumpleaños del jugador, por lo que los valores inferidos igualan las estimaciones salariales correspondientes de ese cumpleaños. La habilidad real aún puede ser menor porque se desconocen las elecciones históricas de entrenamiento de su equipo.",
    seniorTrainingInferencePossiblyInflated: "(posiblemente inflado)",
    seniorTrainingInferencePossiblyInflatedTooltip:
      "Esta predicción basada en TSI supera el límite superior con entrenamiento respaldado por la estimación salarial del jugador y su historial posicional elegible bajo las hipótesis indicadas. La diferencia puede indicar que la predicción basada en TSI está inflada.",
    seniorTrainingInferenceCalculating: "Calculando...",
    seniorTrainingInferenceProgress:
      "Calculando límites superiores con entrenamiento: {{completed}} de {{total}}",
    seniorTrainingInferenceNotApplicable: "No aplicable",
    seniorTrainingInferenceNotApplicableTooltip:
      "Un límite superior con entrenamiento requiere que una sola habilidad futbolística sea claramente superior a todas las demás.",
    seniorTrainingInferenceUnavailable: "No disponible",
    seniorTrainingInferenceUnavailableWage:
      "La predicción Psico basada en salario no está disponible para este jugador.",
    seniorTrainingInferenceUnavailableHistory:
      "No se pudo recuperar el historial completo de partidos sénior o equipos de este jugador.",
    seniorTrainingInferenceUnavailableTimeline:
      "No se pudo reconstruir por completo la cronología posicional del jugador.",
    seniorTrainingInferenceWeeksLabel: "{{weeks}} semanas",
    seniorTrainingInferenceTableTooltip:
      "Inferencia de habilidad como límite superior con entrenamiento, basada en la predicción salarial promedio y el historial posicional elegible del jugador desde su último cumpleaños.",
