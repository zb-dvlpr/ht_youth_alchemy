...
export const messagesFr: Messages = {
    ...
    remindersSnoozeForLabel: "Reporter de",
    remindersSnoozeButtonLabel: "Reporter",
    remindersSnoozeDurationDay: "{{count}} jour",
    remindersSnoozeDurationDays: "{{count}} jours",
    remindersDismissedSectionTitle: "Ignorés",
    remindersNoDismissed: "Aucun rappel ignoré.",
    remindersDismissedAtLabel: "Ignoré {{time}}",
    ...
    reminderClubChronicleArenaOccupancyTitle: "L'utilisation du stade est élevée",
    reminderClubChronicleArenaOccupancyBody:
      "Ton stade était rempli à {{occupancyPct}}% lors du dernier match de ligue à domicile. Pense à l'agrandir.",
    reminderClubChronicleArenaOccupancyBodyWithSoldTotal:
      "Ton stade était rempli à {{occupancyPct}}% lors du dernier match de ligue à domicile ({{soldTotal}} sièges vendus sur {{capacity}}). Pense à l'agrandir.",
    reminderActionExpandArena: "Agrandir le stade",
    reminderClubChronicleArenaOccupancyActionUnavailable:
      "Impossible d'ouvrir la page du stade dans Hattrick.",
    ...
    updateRequiredTitle: "Mise a jour requise",
    updateRequiredBody:
    ...
    changelog_6_1_0:
      "Introduction d'un flux complet d'envoi et de récupération des ordres de composition senior.",
    changelog_6_0_0:
    ...
    changelog_5_7_0:
      "Les HatStats (origine : Foxtrick) sont maintenant incluses dans l analyse de l adversaire.",
    changelog_5_6_0:
    ...
    clubChronicleHelpBulletLeague:
      "Performance en ligue : tableau position, points, serie, coupe, variation de position et difference de buts. La coupe vient des teamdetails et affiche Aucune quand l equipe n est plus en coupe. Cliquez une ligne pour la comparaison precedent/courant par attribut.",
    ...
    clubChronicleHelpBulletFinance:
      "Balance des transferts : nombre d achats, nombre de ventes et solde en EUR. Cliquez une ligne pour le detail des valeurs.",
    ...
    clubChronicleFinancePanelTitle: "Balance des transferts",
    clubChronicleFinanceColumnBuys: "Achats",
    clubChronicleFinanceColumnSales: "Ventes",
    clubChronicleFinanceColumnEstimate: "Solde",
    ...
    clubChronicleDetailModeUser: "Mode utilisateur",
    ...
    clubChronicleColumnCup: "Coupe",
    clubChronicleCupNone: "Aucune",
    ...
    clubChronicleMainSkillEstimationColumn: "Estimation competence principale¹",
    clubChronicleMainSkillEstimationFootnote:
      "¹ L'estimation de competence principale est seulement approximative.",
    clubChronicleMainSkillEstimationTooOld: "Joueur trop vieux",
    ...
    clubChronicleLeagueSectionTitle: "Performance en ligue et coupe",
    ...
    seniorHelpBulletAiIgnoreTraining:
      "Mode sans entrainement: optimise l efficacite du match sans contrainte des postes d entrainement, soit sur toutes les formations, soit uniquement sur les formations avec une experience d entrainement superieure a 3.",
    ...
    setBestLineupIgnoreTrainingTooltip:
      "Définit la composition sans tenir compte du programme d'entraînement. Choisissez entre autoriser toutes les formations et n'autoriser que les formations entraînées.",
    setBestLineupIgnoreTrainingAllowAllFormations: "Autoriser toutes les formations",
    setBestLineupIgnoreTrainingAllowOnlyTrainedFormations:
      "Autoriser seulement les formations entraînées",
    ...
    seniorOtherOrdersSubstitutionsNone: "Aucun remplacement prévu.",
    seniorOtherOrdersPenaltyTakersTitle: "Tireurs de penalties",
    seniorOtherOrdersPenaltyTakersNone: "Aucun ordre de tireurs de penalties.",
    seniorOtherOrdersCaptainTitle: "Capitaine",
    seniorOtherOrdersCoachPick: "Choix du coach",
    seniorOtherOrdersSetPiecesTitle: "Coups de pied arrêtés",
    seniorOtherOrdersMinuteLabel: "Minute",
    seniorOtherOrdersPlayerInLabel: "Entre",
    seniorOtherOrdersPlayerOutLabel: "Sort",
    seniorOtherOrdersOrderTypeLabel: "Consigne",
    seniorOtherOrdersReplaceLabel: "Remplacer",
    seniorOtherOrdersSwapLabel: "Échanger",
    seniorOtherOrdersRepositionLabel: "Repositionner",
    seniorOtherOrdersUnknownOrderLabel: "Inconnu",
    seniorOtherOrdersSpecialOrderLabel: "Spécial",
    seniorOtherOrdersConditionsLabel: "Conditions",
    seniorOtherOrdersCardLabel: "Cartons",
    seniorOtherOrdersStandingLabel: "Score",
    ...
    notificationSeniorIgnoreTrainingNoTrainedFormations:
      "Aucune formation avec une expérience d'entraînement supérieure à 3 n'a été trouvée. Retour à toutes les formations.",
    ...
    youthTrainingChppLimitInfoLabel: "Limitation CHPP de l’entraînement jeunes",
    youthTrainingChppLimitTooltip:
      "CHPP ne permet pas d’importer les régimes d’entraînement jeunes depuis Hattrick ni de les y définir. Si vous voulez que cela change, envoyez une demande de fonctionnalité à Hattrick.",
    ...
    seniorTransferListedIndicatorLabel: "Liste des transferts",
    seniorTransferListedNoBidsYet: "Aucune enchere pour le moment",
    ...
    lineupEmptySlotRecommendationsHint:
      "Cliquez sur les postes vides pour des recommandations de joueurs",
    clearSlot: "Effacer",
    ...
    seniorMlPredictedWageLabel: "Prediction ML",
    seniorMlPredictionDiffLabel: "ecart",
    ...
    lineupSlotLeftWingBack: "Arrière gauche",
    lineupSlotRightWingBack: "Arrière droit",
    lineupSlotLeftCentralDefender: "Défenseur central gauche",
    lineupSlotCentralDefender: "Défenseur central",
    lineupSlotRightCentralDefender: "Défenseur central droit",
    lineupSlotLeftWinger: "Ailier gauche",
    lineupSlotRightWinger: "Ailier droit",
    lineupSlotLeftInnerMidfield: "Milieu central gauche",
    lineupSlotCentralInnerMidfield: "Milieu central",
    lineupSlotRightInnerMidfield: "Milieu central droit",
    lineupSlotLeftForward: "Attaquant gauche",
    lineupSlotCentralForward: "Attaquant central",
    lineupSlotRightForward: "Attaquant droit",
    lineupSlotBenchKeeper: "Gardien remplaçant",
    lineupSlotBenchCentralDefender: "Défenseur central remplaçant",
    lineupSlotBenchWingBack: "Arrière remplaçant",
    lineupSlotBenchInnerMidfield: "Milieu central remplaçant",
    lineupSlotBenchForward: "Attaquant remplaçant",
    lineupSlotBenchWinger: "Ailier remplaçant",
    lineupSlotBenchExtra: "Remplaçant extra",
