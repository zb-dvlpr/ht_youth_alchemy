...
export const messagesFr: Messages = {
    ...
    changelog_4_0_0:
      "Les règles du projet traitent désormais l UX mobile comme un axe de travail à part entière avec des garde-fous explicites contre les régressions desktop.",
    changelog_3_13_0:
