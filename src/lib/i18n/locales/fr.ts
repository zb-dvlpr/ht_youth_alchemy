...
export const messagesFr: Messages = {
    ...
    helpMenuYouTubeChannel: "Chaîne YouTube",
    youtubeWatchRelatedVideo: "Voir la vidéo associée",
    youtubePlayerTitle: "Vidéo YouTube",
    youtubePlayerClose: "Fermer la vidéo",
    youtubePlayerMinimize: "Réduire la vidéo",
    youtubePlayerRestore: "Restaurer la vidéo",
    youtubePlayerOpenExternal: "Ouvrir sur YouTube",
    youtubePlayerAdjust: "Déplacer ou redimensionner la vidéo",
    youtubePlayerDoneAdjusting: "Terminé",
    youtubePlayerAdjustHint:
      "Faites glisser pour déplacer. Pincez pour redimensionner.",
    youtubePlayerResize: "Redimensionner la vidéo",
    youtubeAppOverviewVideoOne: "Regarder la vidéo de présentation Hattrick Alchemy 1",
    youtubeAppOverviewVideoTwo: "Regarder la vidéo de présentation Hattrick Alchemy 2",
    youtubeSeniorSquadOptimizationVideo:
      "Regarder la vidéo d’optimisation de l’équipe senior",
    youtubeSeniorEditSkillsAgeWageTsiVideo:
      "Regarder la vidéo Modifier compétences, âge, salaire et TSI",
    ...
    toolTransferMarket: "Marche des transferts",
    ...
    changelog_6_3_0:
      "Refonte de l'architecture de gestion de la memoire pour reduire le stockage local redondant et deplacer les gros volumes de donnees de Chronique du club vers IndexedDB.",
    changelog_6_2_0:
    ...
    settingsAutoRefreshTitle: "Actualisation automatique",
    ...
    settingsSeniorPredictedRatingsTitle: "Notes prévues",
    settingsSeniorPredictedRatingsExperimentalLabel: "Expérimental",
    settingsSeniorPredictedRatingsToggleLabel: "Activer les notes prévues",
    settingsSeniorPredictedRatingsDescription: "Cette fonctionnalité est expérimentale, car CHPP renvoie actuellement des valeurs incorrectes pour les notes de match prévues. Activez-la seulement si elle vous reste utile. Pensez à signaler le problème via Hattrick Staff Messages en mentionnant que le point de terminaison matchorders renvoie des valeurs incorrectes lorsqu’il est appelé avec predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Rapport de bug",
    settingsSeniorPredictedRatingsReportText: "Objet : Notes prévues incorrectes renvoyées par le point de terminaison CHPP matchorders\n\nBonjour,\n\nLe point de terminaison CHPP matchorders semble renvoyer des valeurs incorrectes lorsque les notes prévues sont demandées avec predictratings=true.\n\nLes notes de secteurs renvoyées ne correspondent pas aux notes attendues pour la composition, les ordres des joueurs, la tactique, l’attitude de match et le contexte du match sélectionnés. Cela empêche les applications CHPP de fournir des notes de match prévues fiables.\n\nPourriez-vous examiner le calcul des notes prévues ou la réponse renvoyée par le point de terminaison matchorders ?\n\nMerci.",
    settingsSeniorPredictedRatingsCopyReportButton: "Copier le rapport",
    settingsSeniorPredictedRatingsReportButton: "Signaler",
    settingsSeniorPredictedRatingsReportCopied: "Rapport copié.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Impossible de copier le rapport. Sélectionnez et copiez le texte manuellement.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Rapport de bug préparé sur les notes prévues",
    ...
    settingsLayoutTitle: "Disposition de l'app",
    settingsLayoutDescription:
      "Automatique utilise les signaux de fenêtre et d'appareil. Mobile utilise toujours la disposition mobile de HT Alchemy, et Bureau utilise toujours sa disposition bureau. Ce réglage ne peut pas modifier l'option Site pour ordinateur de votre navigateur.",
    settingsLayoutSelectLabel: "Préférence de disposition",
    settingsLayoutAuto: "Automatique",
    settingsLayoutMobile: "Mobile",
    settingsLayoutDesktop: "Bureau",
    ...
    settingsDebugSupporterOverrideLabel: "Niveau Supporter Hattrick simule",
    settingsDebugSupporterOverrideHint:
      "Developpement uniquement. Choisissez le niveau Supporter que l app doit simuler.",
    settingsDebugSupporterTierNone: "Aucun",
    settingsDebugSupporterTierSilver: "Argent",
    ...
    clubChronicleHelpBulletFinance:
      "Balance des transferts : nombre d achats, nombre de ventes et solde en the display currency. Cliquez une ligne pour le detail des valeurs.",
    ...
    clubChronicleHelpBulletWages:
      "Salaires : salaire total equipe et top 11 en the display currency. Cliquez une ligne pour des details joueurs triables avec index, age (annees+jours), salaire et notes forme 7 enregistrees avec emoji meteo.",
    ...
    teamScoutInferredTrainingLabel: "Entraînement déduit : {{training}}",
    teamScoutDataMatchesLabel: "Données : {{count}} matchs",
    teamScoutDataMatchLabel: "Données : {{count}} match",
    ...
    matchesTitle: "Matchs",
    seniorMatchesUpcomingTab: "Matchs a venir",
    seniorMatchesTeamSpiritTab: "Esprit d equipe",
    teamSpiritCurrentTeamSpirit: "Esprit d equipe actuel",
    teamSpiritCurrentTeamSpiritTooltip:
      "Remplacez cette valeur manuellement si votre esprit d equipe a ete affecte par une vente de joueur. Cette information n est pas disponible via CHPP.",
    teamSpiritCurrentTeamSpiritInfoAria: "Information sur l esprit d equipe actuel",
    teamSpiritCalculatedCurrent: "Calcule : {{value}}",
    teamSpiritCalculatedUnavailable: "Valeur calculee indisponible",
    teamSpiritSelectedTeamNotInMatch:
      "L equipe senior selectionnee est absente de ces details de match.",
    ...
    teamSpiritLoadingLeagueFixtures: "Chargement du calendrier de ligue...",
    teamSpiritLoadingTeamDetails: "Chargement des details de l equipe...",
    teamSpiritLoadingDetails: "Chargement des details des matchs termines...",
    teamSpiritLoadingClub: "Chargement du staff du club...",
    teamSpiritNoMatches: "Aucun match d esprit d equipe trouve pour cette saison.",
    teamSpiritLoadArchiveFailed: "Impossible de charger les matchs d esprit d equipe.",
    teamSpiritLoadLeagueFixturesFailed: "Impossible de charger le calendrier de ligue.",
    teamSpiritLoadTeamDetailsFailed: "Impossible de charger les details de l equipe.",
    teamSpiritLoadClubFailed: "Impossible de charger le staff du club.",
    teamSpiritLoadMatchDetailsFailed: "Impossible de charger les details du match",
    teamSpiritSeasonUnknown:
      "Impossible de determiner la saison actuelle. Les matchs d esprit d equipe ne peuvent pas encore etre charges.",
    teamSpiritCoachLeadershipDefaultWarning:
      "Le leadership du coach n a pas pu etre determine, weak est utilise.",
    teamSpiritFetchedPsychologistLevel: "Niveau du psychologue sportif charge : {{level}}.",
    ...
    teamSpiritBefore: "Avant",
    teamSpiritBeforeMatch: "TS avant match",
    teamSpiritBeforeMatchTooltip:
      "Remplacez cette valeur manuellement si votre esprit d equipe a ete affecte par une vente de joueur. Cette information n est pas disponible via CHPP.",
    teamSpiritBeforeMatchInfoAria: "Information sur le TS avant match",
    teamSpiritCalculatedSeasonStart:
      "L esprit d equipe de depart calcule pour la saison est {{value}} ({{level}}), d apres le niveau de psychologue sportif {{psychologistLevel}}.",
    teamSpiritMidfield: "Milieu",
    teamSpiritMidfieldIfYou: "si vous ...",
    teamSpiritMidfieldPerformance: "performance du milieu",
    teamSpiritAfterMatch: "TS apres match",
    teamSpiritRecoveryBeforeNext: "Recuperation avant le prochain match TS",
    teamSpiritDailyUpdates: "{{count}} mises a jour quotidiennes",
    teamSpiritAfterRecovery: "Apres recuperation",
    teamSpiritMissingTeamAttitude: "Attitude d equipe manquante",
    teamSpiritCalculationUncertain: "Calcul incertain a partir de ce match.",
    teamSpiritCalculationUnavailable: "Indisponible",
    teamSpiritUnavailableMatchInProgress: "Indisponible car le match est en cours",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "TS calcule indisponible car un match est en cours",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Calcul indisponible car un match est en cours.",
    ...
    optimizeRevealUnavailableTitle: "Révélation indisponible",
    ...
    seniorOtherOrdersTacticalAssistantDetected:
      "Assistant tactique niveau {{level}} detecte. Les fonctions d assistant tactique sont disponibles.",
    seniorOtherOrdersTacticalAssistantSimulated:
      "Simulation dev : assistant tactique niveau {{level}} actif. Les fonctions d assistant tactique sont disponibles.",
    seniorOtherOrdersTacticalAssistantNone:
      "Aucun assistant tactique detecte. La limite standard d ordres s applique.",
    seniorOtherOrdersTacticalAssistantUnknownLevel:
      "Assistant tactique detecte, mais le niveau est inconnu. La limite standard s applique jusqu a l actualisation des donnees du staff.",
    seniorOtherOrdersDevSimulateTacticalAssistant:
      "Dev : simuler l assistant tactique",
    seniorOtherOrdersDevTacticalAssistantLevel:
      "Niveau d assistant tactique simule : {{level}}",
    seniorOtherOrdersPlayerOrdersTitle: "Ordres des joueurs",
    seniorOtherOrdersPlayerOrdersNone: "Aucun ordre de joueur pour le moment.",
    seniorOtherOrdersPlayerOrdersCounter: "Ordres des joueurs : {{count}} / {{max}}",
    seniorOtherOrdersBenchSubstitutionsCount:
      "Remplacements depuis le banc : {{count}} / {{limit}}",
    ...
    seniorOtherOrdersNoStartingXiPlayers: "Aucun joueur titulaire disponible",
    seniorOtherOrdersNoBenchPlayers: "Aucun remplacant disponible",
    ...
    seniorOtherOrdersDeprecatedRedCardCriterion:
      "Critere de carton rouge obsolète",
    ...
    seniorOtherOrdersManMarkingNoOpponent:
      "Choisis un match avant de selectionner une cible de marquage.",
    seniorOtherOrdersOpponentPlayersLoading: "Chargement des joueurs adverses...",
    seniorOtherOrdersOpponentPlayersLoadError:
      "Impossible de charger les joueurs adverses.",
    seniorOtherOrdersOpponentPlayersRetry: "Reessayer",
    seniorOtherOrdersOpponentPlayersNone: "Aucun joueur adverse trouve.",
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Choisir un marqueur",
    seniorOtherOrdersManMarkingTargetPlaceholder: "Choisir une cible",
    ...
    seniorOtherOrdersManMarkingAlternativesTitle: "Alternatives examinées",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Évaluation de la cible",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Évaluation du marqueur",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Évaluation de la paire",
    seniorOtherOrdersManMarkingLimitationsTitle: "Limites importantes",
    seniorOtherOrdersManMarkingLoading: "Préparation de l’évaluation du marquage...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Aucun marqueur n’est actuellement sélectionné.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Aucune cible n’est actuellement sélectionnée.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "Le joueur sélectionné n’occupe pas actuellement une position valable pour le marquage.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} est apparu comme {{role}} dans {{count}} des {{total}} matchs analysés ({{percent}}), sous le seuil de constance requis de {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} a principalement joué comme {{role}}, ce qui n’est pas une position cible éligible pour le marquage individuel.",
    ...
    seniorOtherOrdersManMarkingTargetRoleUnknown: "La position marquable attendue de la cible n’a pas pu être établie à partir de l’historique analysé.",
    seniorOtherOrdersManMarkingNoHistory: "Aucun historique adverse exploitable n’était disponible pour ce contexte de match.",
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Aucune paire évaluée n’avait un bénéfice net estimé positif.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Meilleure paire évaluée non positive :",
    seniorOtherOrdersManMarkingPositiveResult: "Cette paire est positive selon le modèle de marquage de l’application.",
    seniorOtherOrdersManMarkingNeutralResult: "Cette paire est approximativement neutre selon le modèle de marquage de l’application.",
    seniorOtherOrdersManMarkingNegativeResult: "Cette paire est négative selon le modèle de marquage de l’application.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Cette évaluation suppose que l’adversaire aligne le joueur identifié au poste attendu. Elle repose sur les compositions précédentes et des données de joueur estimées. L’adversaire peut utiliser un autre joueur, une autre formation, position, substitution ou tactique ; l’ordre de marquage peut alors être moins efficace ou ne pas s’activer comme prévu. Les compétences adverses et les effets affichés sont des estimations, pas des résultats garantis du moteur de match. Hattrick Alchemy ne peut pas prévoir les décisions inattendues de l’adversaire et décline toute responsabilité quant au résultat. Vérifiez l’ordre final avant de l’envoyer.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Cette conclusion repose uniquement sur les données historiques et estimées disponibles. Ne pas identifier de cible ne prouve pas qu’aucune cible valable n’existe, et une estimation non positive ne garantit pas que le marquage échouerait face à la future composition réelle de l’adversaire. L’adversaire peut agir différemment des matchs précédents.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "défenseur central",
    seniorOtherOrdersManMarkingRoleWingback: "arrière latéral",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "milieu intérieur",
    seniorOtherOrdersManMarkingRoleForward: "attaquant",
    seniorOtherOrdersManMarkingRoleWinger: "ailier",
    seniorOtherOrdersManMarkingRecommendationSummary: "Cette paire avait le plus grand bénéfice net estimé positif parmi {{count}} paires valides évaluées.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Paire sélectionnée",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Cette analyse s’applique au marqueur et à la cible actuellement sélectionnés.",
    seniorOtherOrdersManMarkingTargetConsistency: "Rôle attendu : {{role}}. Le joueur y est apparu dans {{count}} des {{total}} matchs analysés ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Compétence principale brute estimée",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Compétence principale effective estimée",
    seniorOtherOrdersManMarkingSpecialty: "Spécialité",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Multiplicateur de comparaison de la cible",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Force de comparaison ajustée de la cible",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "La cible est choisie dans la meilleure paire complète, pas forcément parce qu’elle a l’estimation individuelle la plus élevée.",
    seniorOtherOrdersManMarkingMarkerSummary: "Le marqueur joue comme {{role}} avec Défense effective {{defending}}, force ajustée {{adjusted}} et valeur positionnelle normale estimée {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Spécialité : {{specialty}}. Multiplicateur de comparaison du marquage : {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Contribution estimée de compétence principale de la cible neutralisée",
    seniorOtherOrdersManMarkingTargetRetained: "Contribution estimée de compétence principale de la cible restante",
    seniorOtherOrdersManMarkingMarkerPenalty: "Réduction de la contribution positionnelle normale du marqueur",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Comme {{markerRole}} et {{targetRole}} forment une paire de rôles proche, le marquage individuel est estimé réduire la contribution positionnelle normale du marqueur de {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Comme {{markerRole}} et {{targetRole}} ne forment pas une paire de rôles proche, le marquage individuel est estimé réduire la contribution positionnelle normale du marqueur de {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Bénéfice net suivant : {{net}}. C’est {{difference}} de moins que la paire recommandée.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Bénéfice net suivant : {{net}}. C’est pratiquement identique à la paire recommandée.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Bénéfice net suivant : {{net}}. C’est {{difference}} de plus que la paire recommandée.",
    seniorOtherOrdersManMarkingValidTargets: "Des estimations de cibles valides sont disponibles.",
    seniorOtherOrdersManMarkingValidMarkers: "Des candidats marqueurs valides sont disponibles.",
    seniorOtherOrdersManMarkingEffectiveDefending: "Défense effective",
    seniorOtherOrdersManMarkingAdjustedStrength: "force ajustée",
    seniorOtherOrdersManMarkingNormalRoleValue: "valeur de rôle normale",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} n’a pas pu être résolu comme joueur de votre équipe.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} n’a pas de valeur de Défense effective disponible.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} a une Défense effective invalide ou non positive.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} n’a pas de valeur positionnelle normale disponible.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} a une valeur positionnelle normale invalide ou non positive.",
    ...
    seniorOtherOrdersBehaviourOffensive: "Offensif",
    seniorOtherOrdersBehaviourDefensive: "Defensif",
    seniorOtherOrdersBehaviourTowardsMiddle: "Vers le centre",
    seniorOtherOrdersBehaviourTowardsWing: "Vers l'aile",
    seniorOtherOrdersBehaviourExtraForward: "Attaquant supplementaire",
    seniorOtherOrdersBehaviourExtraInnerMidfield: "Milieu central supplementaire",
    seniorOtherOrdersBehaviourExtraDefender: "Defenseur supplementaire",
    ...
    analyzeOpponentResultWin: "Victoire",
    analyzeOpponentResultLoss: "Defaite",
    analyzeOpponentResultDraw: "Nul",
    ...
    lineupExclusionTooltip: "Une fois active, ce joueur ne sera pris en compte pour aucune composition.",
    lineupExclusionExcludeLabel: "Exclure {{player}} de la prise en compte pour les compositions",
    ...
    seniorEnterPlayerIdSubmitLabel: "Charger le joueur",
    seniorEnterPlayerIdLoadingLabel: "Chargement du joueur...",
    seniorEnterPlayerIdInvalid: "Saisis un ID joueur numerique valide.",
    seniorEnterPlayerIdNotFound: "L'ID joueur {{playerId}} est introuvable.",
    seniorObservedExternalPlayerNotice: "Ce joueur n'est pas dans ton equipe.",
    seniorObservedExternalPlayerClearLabel: "Effacer le joueur observe",
    ...
    seniorTransferSearchPriceRangeLabel: "Prix ({{currency}})",
    transferSearchHtmsPotentialRangeLabel: "Potentiel HTMS",
    transferSearchHtmsPotentialMinLabel: "Potentiel HTMS min.",
    transferSearchHtmsPotentialMaxLabel: "Potentiel HTMS max.",
    transferSearchNativeCountryLabel: "Pays d'origine",
    transferMarketPastSearchesButton: "Recherches passees",
    transferMarketProfilesTooltip: "Lister les profils de recherche",
    transferMarketProfilesAriaLabel: "Lister les profils de recherche",
    transferMarketSaveAsProfileButton: "Enregistrer comme profil",
    transferMarketProfileNameLabel: "Nom du profil",
    transferMarketProfileNamePlaceholder: "ex. espoirs gardiens",
    transferMarketSaveProfileTitle: "Enregistrer le profil",
    transferMarketSaveProfileConfirm: "Enregistrer le profil",
    transferMarketProfileNameRequired: "Saisissez un nom de profil.",
    transferMarketOverwriteProfileTitle: "Remplacer le profil ?",
    transferMarketOverwriteProfileBody: "Un profil nomme {{name}} existe deja. Le remplacer ?",
    transferMarketOverwriteProfileConfirm: "Remplacer",
    transferMarketOverwriteProfileCancel: "Retour",
    transferMarketProfileSaved: "Profil enregistre.",
    transferMarketProfileOverwritten: "Profil remplace.",
    transferMarketPastSearchesTitle: "Recherches passees",
    transferMarketPastSearchesEmpty: "Aucune recherche passee.",
    ...
    seniorTransferSearchBidAmountLabel: "Montant de l enchere ({{currency}})",
    seniorTransferSearchMaxBidAmountLabel: "Enchere max ({{currency}})",
    ...
    hattrickGoldSupporterActionRequiredTooltip:
      "Necessite Hattrick Supporter Or, Platine ou Diamant.",
    ...
    seniorFoxtrickSimulationWageLabel: "Salaire ({{currency}})",
