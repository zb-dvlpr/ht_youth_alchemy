...
export const messagesFr: Messages = {
    ...
    teamSpiritSeasonStartsAtComposed:
      "La saison commence toujours avec une valeur d esprit d equipe de 4.5 (content).",
