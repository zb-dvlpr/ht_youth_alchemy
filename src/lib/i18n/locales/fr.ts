...
export const messagesFr: Messages = {
    ...
    seniorOtherOrdersManMarkingBestRejectedPair: "Paire évaluée la moins défavorable :",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "Le calcul ci-dessous s’applique à la paire actuellement sélectionnée.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Contribution affectée retirée",
    seniorOtherOrdersManMarkingTargetRetained: "Contribution affectée conservée",
    seniorOtherOrdersManMarkingMarkerPenalty: "Pénalité propre du marqueur",
