...
export const messagesFr: Messages = {
    ...
    seniorTransferSearchPriceRangeLabel: "Prix (display currency)",
    ...
    seniorTransferSearchBidAmountLabel: "Montant de l enchere (display currency)",
    seniorTransferSearchMaxBidAmountLabel: "Enchere max (display currency)",
    ...
    seniorFoxtrickSimulationWageLabel: "Salaire (display currency)",
