...
export const messagesIt: Messages = {
    ...
    helpMenuYouTubeChannel: "Canale YouTube",
    youtubeWatchRelatedVideo: "Guarda il video correlato",
    youtubePlayerTitle: "Video di YouTube",
    youtubePlayerClose: "Chiudi video",
    youtubePlayerMinimize: "Riduci video",
    youtubePlayerRestore: "Ripristina video",
    youtubePlayerOpenExternal: "Apri su YouTube",
    youtubePlayerAdjust: "Sposta o ridimensiona il video",
    youtubePlayerDoneAdjusting: "Fatto",
    youtubePlayerAdjustHint:
      "Trascina per spostare. Pizzica per ridimensionare.",
    youtubePlayerResize: "Ridimensiona video",
    youtubeAppOverviewVideoOne: "Guarda il video panoramico 1 di Hattrick Alchemy",
    youtubeAppOverviewVideoTwo: "Guarda il video panoramico 2 di Hattrick Alchemy",
    youtubeSeniorSquadOptimizationVideo:
      "Guarda il video sull’ottimizzazione della rosa senior",
    youtubeSeniorEditSkillsAgeWageTsiVideo:
      "Guarda il video su modifica abilità, età, stipendio e TSI",
    ...
    toolTransferMarket: "Mercato trasferimenti",
    ...
    changelog_9_1_0:
      "Implementati i calcoli di abilità inferita per giocatori senior e risultati di ricerca trasferimenti",
    changelog_9_0_0:
      "Aggiunta la possibilità di installare Hattrick Alchemy come app autonoma.",
    changelog_8_3_0: "Aggiunti tutorial all’interno dell’app.",
    changelog_8_2_0: "Migliorato l’algoritmo di marcatura a uomo della formazione senior, che ora tiene conto delle abilità effettive, delle specialità dei giocatori, delle penalità di posizione e delle abilità principali stimate dell’avversario.",
    ...
    settingsAutoRefreshTitle: "Aggiornamento automatico",
    ...
    settingsSeniorPredictedRatingsTitle: "Valutazioni previste",
    settingsSeniorPredictedRatingsExperimentalLabel: "Sperimentale",
    settingsSeniorPredictedRatingsToggleLabel: "Abilita valutazioni previste",
    ...
    settingsDebugSupporterOverrideLabel: "Livello Hattrick Supporter simulato",
    settingsDebugSupporterOverrideHint:
      "Solo sviluppo. Scegli il livello Supporter che l app deve simulare.",
    settingsDebugSupporterTierNone: "Nessuno",
    settingsDebugSupporterTierSilver: "Argento",
    settingsDebugSupporterTierGold: "Oro",
    settingsDebugSupporterTierPlatinum: "Platino",
    settingsDebugSupporterTierDiamond: "Diamante",
    settingsDebugTeamSpiritStillInCupLabel: "Simula ancora in coppa principale",
    settingsDebugTeamSpiritStillInCupHint:
      "Mostra una partita di coppa attuale simulata seguita da segnaposto settimanali fino a fine stagione.",
    ...
    clubChronicleHelpBulletTeamAttitude:
      "Team Attitude riusa la formazione piu comune, confronta gli HatStats di campionato con la stessa formazione usando basi separate in casa e fuori, e segnala partite probabilmente PIC, MOTS o normali. Le etichette potenziali usano una rosa base solo di campionato vicina al livello HatStats normale per quel campo.",
    ...
    clubChronicleTeamAttitudeDebugBaselineValuesLabel: "Tutti i valori HatStats",
    ...
    clubChronicleTeamAttitudeDetailsDisclaimer:
      "L'atteggiamento dedotto e una stima euristica basata sugli scostamenti degli HatStats. Questa tabella mostra le partite usate per l'inferenza: partite giocate con la formazione piu dominante ({formation}) e una costellazione di giocatori rappresentativa di una formazione da campionato.",
    ...
    teamScoutDetailInfoButtonLabel: "Informazioni scouting squadra",
    teamScoutInferredTrainingLabel: "Allenamento dedotto: {{training}}",
    teamScoutDataMatchesLabel: "Dati: {{count}} partite",
    teamScoutDataMatchLabel: "Dati: {{count}} partita",
    ...
    seniorMatchesUpcomingTab: "Prossime partite",
    seniorMatchesTeamSpiritTab: "Spirito di squadra",
    teamSpiritCurrentTeamSpirit: "Spirito di squadra attuale",
    ...
    teamSpiritCurrentTeamSpiritInfoAria: "Informazioni sullo spirito di squadra attuale",
    teamSpiritCalculatedCurrent: "Calcolato: {{value}}",
    teamSpiritCalculatedUnavailable: "Valore calcolato non disponibile",
    ...
    teamSpiritCoachSimulationStatus:
      "La leadership allenatore e stata modificata dall'utente in {{leadership}} il {{dateTime}}.",
    teamSpiritPsychologistSimulationLevelStatus:
      "Il livello dello psicologo sportivo e stato modificato dall'utente in {{level}} il {{dateTime}}.",
    teamSpiritPsychologistSimulationDisabledStatus:
      "Lo psicologo sportivo e stato disattivato dall'utente il {{dateTime}}.",
    ...
    teamSpiritLoadingLeagueFixtures: "Caricamento calendario di campionato...",
    teamSpiritLoadingTeamDetails: "Caricamento dettagli squadra...",
    teamSpiritLoadingDetails: "Caricamento dettagli partite completate...",
    teamSpiritLoadingClub: "Caricamento staff club...",
    teamSpiritNoMatches: "Nessuna partita spirito di squadra trovata per questa stagione.",
    teamSpiritLoadArchiveFailed: "Impossibile caricare le partite spirito di squadra.",
    teamSpiritLoadLeagueFixturesFailed: "Impossibile caricare il calendario di campionato.",
    teamSpiritLoadTeamDetailsFailed: "Impossibile caricare i dettagli squadra.",
    teamSpiritLoadClubFailed: "Impossibile caricare lo staff del club.",
    teamSpiritLoadMatchDetailsFailed: "Impossibile caricare i dettagli partita",
    teamSpiritSeasonUnknown:
      "Impossibile determinare la stagione attuale. Le partite spirito di squadra non possono ancora essere caricate.",
    teamSpiritCoachLeadershipDefaultWarning:
      "Leadership allenatore non determinata, viene usato weak.",
    teamSpiritFetchedPsychologistLevel: "Livello psicologo sportivo caricato: {{level}}.",
    teamSpiritLeagueMatch: "Partita di campionato",
    teamSpiritMainCupMatch: "Partita coppa principale",
    teamSpiritMainCupPlaceholder: "Partita coppa principale segnaposto",
    teamSpiritMainCupPlaceholderExplanation:
      "Questa partita di coppa ipotetica viene mostrata solo mentre la tua squadra e ancora nella coppa principale. Scomparira dopo l eliminazione.",
    teamSpiritDebugMainCupMatch: "Partita attuale simulata di coppa principale",
    teamSpiritAttitude: "Atteggiamento",
    teamSpiritAttitudeUsed: "Atteggiamento usato",
    teamSpiritAttitudeToBeUsed: "Atteggiamento da usare",
    ...
    teamSpiritBeforeMatch: "TS prima partita",
    ...
    teamSpiritAfterMatch: "TS dopo partita",
    teamSpiritRecoveryBeforeNext: "Recupero prima della prossima partita TS",
    teamSpiritDailyUpdates: "{{count}} aggiornamenti giornalieri",
    teamSpiritAfterRecovery: "Dopo recupero",
    teamSpiritMissingTeamAttitude: "Atteggiamento squadra mancante",
    teamSpiritCalculationUncertain: "Calcolo incerto da questa partita.",
    teamSpiritCalculationUnavailable: "Non disponibile",
    teamSpiritUnavailableMatchInProgress: "Non disponibile mentre la partita e in corso",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "TS calcolato non disponibile perche una partita e in corso",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Calcolo non disponibile perche una partita e in corso.",
    ...
    optimizeRevealUnavailableTitle: "Rivelazione non disponibile",
    ...
    seniorOtherOrdersResetManMarkingRecommendation: "Reimposta la marcatura a uomo sulla raccomandazione dell’algoritmo",
    seniorOtherOrdersMarkerLabel: "Candidati marcatori idonei",
    seniorOtherOrdersTargetLabel: "Candidati bersaglio idonei",
    ...
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Scegli marcatore",
    ...
    seniorOtherOrdersManMarkingAlternativesTitle: "Alternative considerate",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Valutazione del bersaglio",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Valutazione del marcatore",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Valutazione della coppia",
    seniorOtherOrdersManMarkingLimitationsTitle: "Limitazioni importanti",
    seniorOtherOrdersManMarkingLoading: "Preparazione della valutazione della marcatura...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Nessun marcatore è attualmente selezionato.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Nessun bersaglio è attualmente selezionato.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "Il giocatore selezionato non è schierato in una posizione valida per la marcatura.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} è apparso come {{role}} in {{count}} di {{total}} partite analizzate ({{percent}}), sotto la soglia di continuità richiesta di {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} ha giocato prevalentemente come {{role}}, che non è una posizione bersaglio idonea per la marcatura a uomo.",
    ...
    seniorOtherOrdersManMarkingTargetRoleUnknown: "Non è stato possibile stabilire dall’analisi storica la posizione marcabile attesa del bersaglio.",
    seniorOtherOrdersManMarkingNoHistory: "Nessuno storico avversario utilizzabile era disponibile per questo contesto di partita.",
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Nessuna coppia valutata aveva un beneficio netto stimato positivo.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Migliore coppia valutata non positiva:",
    seniorOtherOrdersManMarkingPositiveResult: "Questa coppia è positiva secondo il modello di marcatura dell’app.",
    seniorOtherOrdersManMarkingNeutralResult: "Questa coppia è circa neutra secondo il modello di marcatura dell’app.",
    seniorOtherOrdersManMarkingNegativeResult: "Questa coppia è negativa secondo il modello di marcatura dell’app.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Questa valutazione presume che l’avversario schieri il giocatore identificato nella posizione attesa. Si basa su formazioni precedenti e dati stimati dei giocatori. L’avversario può usare un altro giocatore, formazione, posizione, sostituzione o piano tattico; in tal caso l’ordine può essere meno efficace o non attivarsi come previsto. Le abilità avversarie e gli effetti mostrati sono stime, non risultati garantiti del motore di gioco. Hattrick Alchemy non può prevedere decisioni inattese dell’avversario e non si assume responsabilità per il risultato. Controlla l’ordine finale prima di inviarlo.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Questa conclusione si basa solo sui dati storici e stimati disponibili. Non identificare un bersaglio non dimostra che non esista un bersaglio adatto, e una stima non positiva non garantisce che la marcatura fallirebbe contro la futura formazione reale dell’avversario. L’avversario può comportarsi diversamente dalle partite precedenti.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "difensore centrale",
    seniorOtherOrdersManMarkingRoleWingback: "terzino",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "centrocampista centrale",
    seniorOtherOrdersManMarkingRoleForward: "attaccante",
    seniorOtherOrdersManMarkingRoleWinger: "ala",
    seniorOtherOrdersManMarkingRecommendationSummary: "Questa coppia aveva il maggiore beneficio netto stimato positivo tra {{count}} coppie valide valutate.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Coppia selezionata",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Questa analisi si applica al marcatore e al bersaglio attualmente selezionati.",
    seniorOtherOrdersManMarkingTargetConsistency: "Ruolo atteso: {{role}}. Il giocatore è apparso lì in {{count}} di {{total}} partite analizzate ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Abilità principale grezza stimata",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Abilità principale effettiva stimata",
    seniorOtherOrdersManMarkingSpecialty: "Specialità",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Moltiplicatore di confronto del bersaglio",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Forza di confronto del bersaglio ajustata",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "Il bersaglio è scelto come parte della migliore coppia completa, non necessariamente perché abbia la stima individuale più alta.",
    seniorOtherOrdersManMarkingMarkerSummary: "Il marcatore gioca come {{role}} con Difesa effettiva {{defending}}, forza ajustata {{adjusted}} e valore posizionale normale stimato {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Specialità: {{specialty}}. Moltiplicatore di confronto della marcatura: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Contributo stimato di abilità principale del bersaglio neutralizzato",
    seniorOtherOrdersManMarkingTargetRetained: "Contributo stimato di abilità principale del bersaglio rimanente",
    seniorOtherOrdersManMarkingMarkerPenalty: "Riduzione del contributo posizionale normale del marcatore",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Poiché {{markerRole}} e {{targetRole}} formano una coppia di ruoli vicina, si stima che la marcatura a uomo riduca il contributo posizionale normale del marcatore di {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Poiché {{markerRole}} e {{targetRole}} non formano una coppia di ruoli vicina, si stima che la marcatura a uomo riduca il contributo posizionale normale del marcatore di {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Beneficio netto successivo: {{net}}. È {{difference}} più basso della coppia raccomandata.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Beneficio netto successivo: {{net}}. È praticamente uguale alla coppia raccomandata.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Beneficio netto successivo: {{net}}. È {{difference}} più alto della coppia raccomandata.",
    seniorOtherOrdersManMarkingValidTargets: "Sono disponibili stime valide dei bersagli.",
    seniorOtherOrdersManMarkingValidMarkers: "Sono disponibili candidati marcatori validi.",
    seniorOtherOrdersManMarkingEffectiveDefending: "Difesa effettiva",
    seniorOtherOrdersManMarkingAdjustedStrength: "forza ajustata",
    seniorOtherOrdersManMarkingNormalRoleValue: "valore normale del ruolo",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} non è stato risolto come tuo giocatore.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} non ha un valore di Difesa effettiva disponibile.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} ha una Difesa effettiva non valida o non positiva.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} non ha un valore posizionale normale disponibile.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} ha un valore posizionale normale non valido o non positivo.",
    ...
    analyzeOpponentMatchFallback: "Partita {{matchId}}",
    ...
    trainingScoringAndSetPieces: "Finalizzazione e calci piazzati",
    ...
    seniorEnterPlayerIdButtonLabel: "Inserisci ID giocatore",
    seniorEnterPlayerIdTooltip:
      "Visualizza i dettagli di un giocatore che non fa parte della tua squadra.",
    seniorEnterPlayerIdModalTitle: "Inserisci ID giocatore",
    seniorEnterPlayerIdInputLabel: "ID giocatore",
    seniorEnterPlayerIdPlaceholder: "Inserisci ID giocatore numerico",
    seniorEnterPlayerIdSubmitLabel: "Carica giocatore",
    seniorEnterPlayerIdLoadingLabel: "Caricamento giocatore...",
    seniorEnterPlayerIdInvalid: "Inserisci un ID giocatore numerico valido.",
    seniorEnterPlayerIdNotFound: "ID giocatore {{playerId}} non trovato.",
    seniorObservedExternalPlayerNotice: "Questo giocatore non e nella tua squadra.",
    seniorObservedExternalPlayerClearLabel: "Cancella giocatore osservato",
    ...
    transferSearchHtmsPotentialRangeLabel: "Potenziale HTMS",
    transferSearchHtmsPotentialMinLabel: "Potenziale HTMS min.",
    transferSearchHtmsPotentialMaxLabel: "Potenziale HTMS max.",
    transferSearchNativeCountryLabel: "Paese d'origine",
    transferMarketPastSearchesButton: "Ricerche passate",
    transferMarketProfilesTooltip: "Elenca profili di ricerca",
    transferMarketProfilesAriaLabel: "Elenca profili di ricerca",
    transferMarketSaveAsProfileButton: "Salva come profilo",
    transferMarketProfileNameLabel: "Nome profilo",
    transferMarketProfileNamePlaceholder: "es. prospetti portieri",
    transferMarketSaveProfileTitle: "Salva profilo di ricerca",
    transferMarketSaveProfileConfirm: "Salva profilo",
    transferMarketProfileNameRequired: "Inserisci un nome profilo.",
    transferMarketOverwriteProfileTitle: "Sovrascrivere il profilo?",
    transferMarketOverwriteProfileBody: "Esiste gia un profilo chiamato {{name}}. Sovrascriverlo?",
    transferMarketOverwriteProfileConfirm: "Sovrascrivi",
    transferMarketOverwriteProfileCancel: "Indietro",
    transferMarketProfileSaved: "Profilo salvato.",
    transferMarketProfileOverwritten: "Profilo sovrascritto.",
    transferMarketPastSearchesTitle: "Ricerche passate",
    transferMarketPastSearchesEmpty: "Nessuna ricerca passata.",
    transferMarketProfilesTitle: "Profili di ricerca",
    transferMarketProfilesEmpty: "Nessun profilo salvato.",
    transferMarketLoadButton: "Carica",
    transferMarketDeleteProfileButton: "Elimina",
    transferMarketProfileDeleted: "Profilo eliminato.",
    ...
    hattrickGoldSupporterActionRequiredTooltip:
      "Richiede Hattrick Supporter Oro, Platino o Diamante.",
    ...
    seniorTrainingInferenceTableLabel: "Limite superiore inferito",
    ...
    sortShirtNumber: "Numero di maglia",
    sortCustom: "--",
    ...
    seniorTrainingInferenceGroupLabel: "Limite superiore abilità con allenamento",
    seniorTrainingInferenceValueLabel: "Valore abilità inferito",
    seniorTrainingInferenceTooltip:
      "Questa è un’inferenza di abilità come limite superiore. Supponendo che il giocatore sia stato allenato in {{skill}} ogni volta che era idoneo, ha accumulato l’equivalente di {{weeks}} settimane di allenamento in posizioni da {{skill}} dal suo ultimo compleanno. I valori combinano le stime basate sullo stipendio a quel compleanno con questa storia posizionale, usando allenatore livello 7, 10 livelli assistenti, intensità 100% e quota resistenza 10%. L’abilità reale del giocatore può essere più bassa perché le scelte storiche di allenamento della sua squadra sono sconosciute.",
    seniorTrainingInferenceZeroMinutesTooltip:
      "Questa è un’inferenza di abilità come limite superiore. Non sono stati identificati minuti idonei di allenamento {{skill}} dall’ultimo compleanno del giocatore, quindi i valori inferiti equivalgono alle rispettive stime salariali di quel compleanno. L’abilità reale può comunque essere più bassa perché le scelte storiche di allenamento della sua squadra sono sconosciute.",
    seniorTrainingInferencePossiblyInflated: "(forse gonfiato)",
    seniorTrainingInferencePossiblyInflatedTooltip:
      "Questa previsione basata sul TSI supera il limite superiore con allenamento supportato dalla stima salariale del giocatore e dalla storia posizionale idonea osservata secondo le ipotesi indicate. La differenza può indicare che la previsione basata sul TSI è gonfiata.",
    seniorTrainingInferenceCalculating: "Calcolo...",
    seniorTrainingInferenceProgress:
      "Calcolo dei limiti superiori con allenamento: {{completed}} di {{total}}",
    seniorTrainingInferenceNotApplicable: "Non applicabile",
    seniorTrainingInferenceNotApplicableTooltip:
      "Un limite superiore con allenamento richiede che una sola abilità calcistica sia chiaramente più alta di tutte le altre.",
    seniorTrainingInferenceUnavailable: "Non disponibile",
    seniorTrainingInferenceUnavailableWage:
      "La previsione Psico basata sullo stipendio non è disponibile per questo giocatore.",
    seniorTrainingInferenceUnavailableHistory:
      "Non è stato possibile recuperare la storia completa di partite senior o squadre per questo giocatore.",
    seniorTrainingInferenceUnavailableTimeline:
      "La cronologia posizionale del giocatore non è stata ricostruita completamente.",
    seniorTrainingInferenceWeeksLabel: "{{weeks}} settimane",
    seniorTrainingInferenceTableTooltip:
      "Inferenza di abilità come limite superiore con allenamento, basata sulla previsione salariale media e sulla storia posizionale idonea del giocatore dal suo ultimo compleanno.",
