...
export const messagesIt: Messages = {
    ...
    settingsSeniorPredictedRatingsDescription: "Questa funzione è sperimentale perché CHPP attualmente restituisce valori errati per le valutazioni previste della partita. Abilitala solo se la trovi comunque utile. Valuta di segnalare il problema tramite Hattrick Staff Messages e indica che l’endpoint matchorders restituisce valori errati quando viene chiamato con predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Segnalazione bug",
    settingsSeniorPredictedRatingsReportText: "Oggetto: Valutazioni previste errate restituite dall’endpoint CHPP matchorders\n\nCiao,\n\nl’endpoint CHPP matchorders sembra restituire valori errati quando le valutazioni previste vengono richieste usando predictratings=true.\n\nLe valutazioni dei settori restituite non corrispondono alle valutazioni attese per la formazione selezionata, gli ordini dei giocatori, la tattica, l’atteggiamento di partita e il contesto della partita. Questo impedisce alle applicazioni CHPP di fornire valutazioni previste affidabili.\n\nPotreste verificare il calcolo delle valutazioni previste o la risposta restituita dall’endpoint matchorders?\n\nGrazie.",
    settingsSeniorPredictedRatingsCopyReportButton: "Copia segnalazione",
    settingsSeniorPredictedRatingsReportButton: "Segnala",
    settingsSeniorPredictedRatingsReportCopied: "Segnalazione copiata.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Impossibile copiare la segnalazione. Seleziona e copia il testo manualmente.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Segnalazione bug preparata sulle valutazioni previste",
