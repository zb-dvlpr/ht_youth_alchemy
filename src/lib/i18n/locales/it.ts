...
export const messagesIt: Messages = {
    ...
    seniorTransferSearchPriceRangeLabel: "Prezzo (display currency)",
    ...
    seniorTransferSearchBidAmountLabel: "Offerta (display currency)",
    seniorTransferSearchMaxBidAmountLabel: "Offerta max (display currency)",
    ...
    seniorFoxtrickSimulationWageLabel: "Stipendio (display currency)",
