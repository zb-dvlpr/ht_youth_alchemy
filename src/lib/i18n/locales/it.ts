...
export const messagesIt: Messages = {
    ...
    remindersSnoozeForLabel: "Posticipa di",
    remindersSnoozeButtonLabel: "Posticipa",
    remindersSnoozeDurationDay: "{{count}} giorno",
    remindersSnoozeDurationDays: "{{count}} giorni",
    remindersDismissedSectionTitle: "Ignorati",
    remindersNoDismissed: "Nessun promemoria ignorato.",
    remindersDismissedAtLabel: "Ignorato {{time}}",
    ...
    reminderSeniorSalaryIncreaseTitle: "Lo stipendio del giocatore è aumentato molto",
    reminderSeniorSalaryIncreaseBody:
      "Lo stipendio di {{playerName}} è aumentato da {{previousSalary}} a {{currentSalary}}. Vuoi vendere il giocatore?",
    reminderActionSellPlayer: "Vendi giocatore",
    reminderSeniorSalaryIncreaseActionUnavailable:
      "Impossibile aprire questo giocatore in Hattrick.",
    reminderSeniorMatchLineupMissingTitle:
      "Nessun ordine impostato per la prossima partita senior",
    reminderYouthMatchLineupMissingTitle:
      "Nessun ordine impostato per la prossima partita giovanile",
    reminderMatchLineupMissingBody:
      "{{matchName}} inizia tra {{timeRemaining}} e non ha ordini impostati.",
    reminderActionSetOrders: "Imposta ordini",
    reminderMatchLineupMissingActionUnavailable:
      "Impossibile aprire lo strumento per questo promemoria.",
    reminderYouthPromotionTitle: "Giocatore giovanile presto promuovibile",
    reminderYouthPromotionBody:
      "{{playerName}} potrà essere promosso tra {{timeRemaining}}.",
    ...
    chppPermissionPlaceBidLabel: "Fai un’offerta",
    chppPermissionPlaceBidDescription:
      "Ti consente di fare offerte per i giocatori sul mercato, ad esempio tramite Trova giocatori simili o Stima il valore del giocatore.",
    chppPermissionSetMatchOrderLabel: "Imposta ordini partita",
    chppPermissionSetMatchOrderDescription:
      "Ti consente di inviare le formazioni a Hattrick.",
    chppPermissionSetTrainingLabel: "Imposta allenamento",
    chppPermissionSetTrainingDescription:
      "Ti consente di modificare il programma di allenamento della squadra maggiore.",
    chppMissingPlaceBidTooltip:
      "Per usare questa funzione, il token CHPP deve essere stato acquisito con il permesso Fai un’offerta.",
    chppMissingSetMatchOrderTooltip:
      "Per usare questa funzione, il token CHPP deve avere il permesso Imposta ordini partita.",
    chppMissingSetTrainingTooltip:
      "Per usare questa funzione, il token CHPP deve avere il permesso Imposta allenamento.",
    ...
    appLicenseFeatureSeniorRatingsTitle: "Modifica manualmente i rating",
    appLicenseFeatureSeniorRatingsDescription:
      "I giocatori vengono selezionati in base ai rating. Modifica manualmente la matrice dei rating per forzare o impedire una selezione e rifinire la tua formazione.",
    ...
    appLicenseFeatureChronicleLikelyTrainingTitle: "Probabile regime di allenamento",
    appLicenseFeatureChronicleLikelyTrainingDescription:
      "Deduce cosa sta allenando questa squadra in base alle formazioni usate nelle partite allenabili.",
    appLicenseFeatureChronicleTrackingTitle: "Tracciamento Club Chronicle illimitato",
    appLicenseFeatureChronicleTrackingDescription:
      "Sblocca schede aggiuntive di Club Chronicle e più squadre tracciate per scheda. Così puoi seguire gruppi più grandi di rivali senza ridurre la watchlist.",
    ...
    changelog_6_4_0:
      "Aggiunti controlli di esclusione giocatore per le formazioni giovanili e senior.",
    changelog_6_3_0:
    ...
    changelog_5_7_0:
      "Gli HatStats (origine: Foxtrick) sono ora inclusi nell analisi dell avversario.",
    changelog_5_6_0:
      "Dettagli giocatore migliorati per i pannelli TSI e stipendi in Club Chronicle.",
    changelog_5_5_0:
    ...
    settingsLicenseExpiringWeekTitle: "La licenza sta per scadere",
    settingsLicenseExpiringWeekBody:
      "La tua licenza premium HT Alchemy scadrà tra circa 1 settimana. Acquista ora un nuovo abbonamento per mantenere attive le funzioni premium senza interruzioni.",
    settingsLicenseExpiringDayTitle: "La licenza sta per scadere",
    settingsLicenseExpiringDayBody:
      "La tua licenza premium HT Alchemy scadrà tra circa 1 giorno. Acquista ora un nuovo abbonamento per mantenere attive le funzioni premium senza interruzioni.",
    settingsLicenseRenewButton: "Acquista un nuovo abbonamento",
    ...
    settingsLicenseNoActive: "Nessuna licenza attiva.",
    settingsLicenseLoading: "Caricamento dei dettagli della licenza…",
    settingsLicenseStatusLabel: "Stato attuale",
    settingsLicenseStatusActive: "Attiva",
    settingsLicenseStatusInactive: "Inattiva",
    settingsLicenseStatusExpired: "Scaduta",
    settingsLicenseStatusDisabled: "Disabilitata",
    settingsLicenseDetailStatus: "Stato della licenza",
    settingsLicenseDetailKey: "Chiave di licenza",
    settingsLicenseDetailActivationLimit: "Limite di attivazione",
    settingsLicenseDetailActivationUsage: "Utilizzo delle attivazioni",
    settingsLicenseDetailCreatedAt: "Creata il",
    settingsLicenseDetailExpiresAt: "Scade il",
    settingsLicenseDetailInstanceId: "ID istanza",
    settingsLicenseDetailInstanceName: "Nome istanza",
    settingsLicenseDetailInstanceCreatedAt: "Istanza creata il",
    settingsLicenseDetailStoreId: "ID negozio",
    settingsLicenseDetailOrderItemId: "ID riga ordine",
    settingsLicenseDetailProductId: "ID prodotto",
    settingsLicenseDetailProduct: "Prodotto",
    settingsLicenseDetailVariantId: "ID variante",
    settingsLicenseDetailVariant: "Variante",
    settingsLicenseDetailOrderId: "ID ordine",
    settingsLicenseDetailCustomerId: "ID cliente",
    settingsLicenseDetailCustomerName: "Nome cliente",
    settingsLicenseDetailCustomerEmail: "E-mail cliente",
    settingsLicenseNeverExpires: "Mai",
    ...
    clubChronicleHelpBulletTsi:
      "TSI: TSI totale squadra e TSI top-11. Clicca una riga per dettagli giocatore ordinabili con indice, eta (anni+giorni), TSI e valutazioni partita forma 7 salvate con emoji meteo.",
    ...
    clubChronicleMainSkillEstimationColumn: "Stima abilita principale¹",
    clubChronicleMainSkillEstimationFootnote:
      "¹ La stima dell'abilita principale e solo approssimativa.",
    clubChronicleMainSkillEstimationTooOld: "Giocatore troppo vecchio",
    clubChronicleForm7RatingColumn: "Valutazione forma 7",
    clubChronicleManMarkerColumn: "MM?",
    clubChronicleManMarkerTooltip:
      "Indica se il giocatore e stato usato come marcatore a uomo.",
    clubChronicleForm7RatingInfoLabel: "Informazioni valutazione forma 7",
    clubChronicleForm7RatingInfoTooltip:
      "Mostra le valutazioni in stelle di fine partita dalle gare in cui il giocatore ha avuto o ha attualmente forma 7. Questo aiuta a stimare una prestazione standardizzata in stelle dei giocatori.",
    clubChronicleWeatherRain: "Pioggia",
    clubChronicleWeatherOvercast: "Coperto",
    clubChronicleWeatherPartiallyCloudy: "Parzialmente nuvoloso",
    clubChronicleWeatherSunny: "Soleggiato",
    clubChroniclePlayerFormColumn: "Forma",
    clubChroniclePlayerStaminaColumn: "Resistenza",
    clubChroniclePlayerExperienceColumn: "Esp.",
    clubChroniclePlayerLeadershipColumn: "Leadership",
    clubChroniclePlayerLoyaltyColumn: "Fedelta",
    ...
    seniorOtherOrdersButton: "Altri ordini",
    seniorOtherOrdersTitle: "Altri ordini",
    seniorOtherOrdersTooltip:
      "Modifica atteggiamento partita, ordini giocatore, rigoristi, capitano e calci piazzati.",
    seniorOtherOrdersDisabledTooltip:
      "Carica i dati dei giocatori senior prima di modificare gli altri ordini.",
    seniorOtherOrdersManMarkingTitle: "Marcatura a uomo",
    seniorOtherOrdersManMarkingNone: "Nessuna istruzione di marcatura a uomo.",
    seniorOtherOrdersSubstitutionsTitle: "Sostituzioni pianificate",
    seniorOtherOrdersSubstitutionsNone: "Nessuna sostituzione pianificata.",
    seniorOtherOrdersPenaltyTakersTitle: "Rigoristi",
    seniorOtherOrdersPenaltyTakersNone: "Nessun ordine dei rigoristi.",
    seniorOtherOrdersCaptainTitle: "Capitano",
    seniorOtherOrdersCoachPick: "Scelta allenatore",
    seniorOtherOrdersSetPiecesTitle: "Calci piazzati",
    seniorOtherOrdersMinuteLabel: "Minuto",
    seniorOtherOrdersPlayerInLabel: "Entra",
    seniorOtherOrdersPlayerOutLabel: "Esce",
    seniorOtherOrdersOrderTypeLabel: "Ordine",
    seniorOtherOrdersReplaceLabel: "Sostituisci",
    seniorOtherOrdersSwapLabel: "Scambia",
    seniorOtherOrdersRepositionLabel: "Riposiziona",
    seniorOtherOrdersUnknownOrderLabel: "Sconosciuto",
    seniorOtherOrdersSpecialOrderLabel: "Speciale",
    seniorOtherOrdersConditionsLabel: "Condizioni",
    seniorOtherOrdersCardLabel: "Cartellini",
    seniorOtherOrdersStandingLabel: "Risultato",
    ...
    seniorOtherOrdersBenchSubstitutionLimitReached: "Puoi definire al massimo 3 sostituzioni dalla panchina.",
    ...
    seniorOtherOrdersSetPiecesKeeperInvalid: "Il portiere non puo essere selezionato come tiratore dei calci piazzati.",
    seniorOtherOrdersInvalidManMarkingTarget: "Le marquage individuel necessite une cible adverse valide.",
    seniorOtherOrdersWrongMatchContext: "Gli altri ordini salvati appartengono a un altra partita. Apri Altri ordini e salva una bozza attuale prima di inviare questa partita.",
    seniorOtherOrdersNoLineupPlayers: "Assegna giocatori alla formazione o alla panchina per scegliere rigoristi, capitano e calci piazzati.",
    seniorOtherOrdersNoStartingXiPlayers: "Nessun titolare disponibile",
    seniorOtherOrdersNoBenchPlayers: "Nessun giocatore in panchina disponibile",
    ...
    seniorOtherOrdersDeprecatedRedCardCriterion:
      "Criterio cartellino rosso deprecato",
    ...
    seniorOtherOrdersManMarkingNoOpponent:
      "Scegli una partita prima di selezionare il bersaglio della marcatura.",
    seniorOtherOrdersOpponentPlayersLoading: "Caricamento giocatori avversari...",
    ...
    seniorOtherOrdersBehaviourNormal: "Normale",
    seniorOtherOrdersBehaviourOffensive: "Offensivo",
    seniorOtherOrdersBehaviourDefensive: "Difensivo",
    seniorOtherOrdersBehaviourTowardsMiddle: "Verso il centro",
    seniorOtherOrdersBehaviourTowardsWing: "Verso la fascia",
    seniorOtherOrdersBehaviourExtraForward: "Attaccante extra",
    seniorOtherOrdersBehaviourExtraInnerMidfield: "Centrocampista extra",
    seniorOtherOrdersBehaviourExtraDefender: "Difensore extra",
    ...
    analyzeOpponentHatstatsBreakdown: "HatStats dif/cen/att/tot",
    ...
    youthTrainingChppLimitInfoLabel: "Limitazione CHPP sull'allenamento giovanile",
    youthTrainingChppLimitTooltip:
      "CHPP non consente di importare da Hattrick o impostare in Hattrick i regimi di allenamento giovanile. Se vuoi che questo cambi, invia una richiesta di funzionalità a Hattrick.",
    ...
    lineupExclusionTooltip: "Quando attivo, questo giocatore non verra considerato per nessuna formazione.",
    lineupExclusionExcludeLabel: "Escludi {{player}} dalla considerazione per le formazioni",
    lineupExclusionAllowLabel: "Consenti a {{player}} di essere considerato per le formazioni",
    ...
    seniorTransferSearchSupporterOnlyTooltip:
      "Questa azione e disponibile solo per i Supporter di Hattrick.",
