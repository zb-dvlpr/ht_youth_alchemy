...
export const messagesNl: Messages = {
  ...
  seniorOtherOrdersUnknownOpponentPlayer: "Speler {{playerId}}",
    ...
    seniorOtherOrdersManMarkingBestRejectedPair: "Minst ongunstige beoordeelde paar:",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "De berekening hieronder geldt voor het momenteel geselecteerde paar.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Verwijderde beïnvloede bijdrage",
    seniorOtherOrdersManMarkingTargetRetained: "Behouden beïnvloede bijdrage",
    seniorOtherOrdersManMarkingMarkerPenalty: "Zelfstraf mandekker",
