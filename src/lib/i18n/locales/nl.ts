...
export const messagesNl: Messages = {
  ...
  helpOpenTooltip: "Hulp en changelog",
  ...
  settingsDebug: "Debug",
  settingsDebugTitle: "Debug-instellingen",
  refresh: "Vernieuwen",
  ...
  skillsMatrixTabLabel: "Skillsmatrix",
  ratingsMatrixTabLabel: "Ratingsmatrix",
  ratingsTitle: "Ratingsmatrix",
  ...
  scoutOverallSkillLevelTooltip: "Algemeen skillniveau",
  ...
  setBestLineupTooltip: "Zet de best mogelijke opstelling met AI.",
  ...
  oauthErrorServerExplanation: "Hattrick OAuth/CHPP gaf een serverfout terug (5xx). Dit is een upstream serviceprobleem.",
  oauthErrorUnknownExplanation: "Hattrick OAuth/CHPP gaf een onverwachte fout tijdens verversen van data.",
  oauthErrorRecoveryHint: "Probeer toegang te ontkoppelen en opnieuw te koppelen. Als het blijft misgaan, neem contact op met Hattrick support.",
  ...
  notificationStaleRefresh: "Verversing gestart door verouderde data.",
  ...
  trainingTitle: "Gerichte skilltraining",
  ...
  tacticCounterAttacks: "Counter-aanval",
  ...
  debugYouthSeFetchHint:
    "Logt gevolgde speciale gebeurtenissen in de console: event-id, object-/subjectnamen en wedstrijd-URL.",
  ...
  optimizeMenuRatings: "Optimaliseer op ratings",
