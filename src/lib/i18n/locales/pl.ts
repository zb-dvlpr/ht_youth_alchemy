...
export const messagesPl: Messages = {
  ...
  youtubeWatchRelatedVideo: "Obejrzyj powiązany film",
  youtubePlayerTitle: "Film YouTube",
  youtubePlayerClose: "Zamknij film",
  youtubePlayerMinimize: "Zminimalizuj film",
  youtubePlayerRestore: "Przywróć film",
  youtubePlayerOpenExternal: "Otwórz w YouTube",
  youtubePlayerAdjust: "Przenieś lub zmień rozmiar filmu",
  youtubePlayerDoneAdjusting: "Gotowe",
  ...
  toolTransferMarket: "Rynek transferowy",
  ...
  teamScoutInferredTrainingLabel: "Wywnioskowany trening: {{training}}",
  teamScoutDataMatchesLabel: "Dane: {{count}} meczów",
  teamScoutDataMatchLabel: "Dane: {{count}} mecz",
  ...
  settingsAutoRefreshTitle: "Automatyczne odświeżanie",
  ...
  settingsLayoutDescription:
    "Automatycznie używa sygnałów okna i urządzenia. Mobilny zawsze używa mobilnego układu HT Alchemy, a Pulpit zawsze używa układu desktopowego. To ustawienie nie może zmienić opcji Wersja na komputer w przeglądarce.",
  settingsLayoutSelectLabel: "Preferencja układu",
  settingsLayoutAuto: "Automatycznie",
  settingsLayoutMobile: "Mobilny",
  settingsLayoutDesktop: "Pulpit",
  ...
  transferMarketPastSearchesButton: "Poprzednie wyszukiwania",
  transferMarketProfilesTooltip: "Lista profili wyszukiwania",
  transferMarketProfilesAriaLabel: "Lista profili wyszukiwania",
  transferMarketSaveAsProfileButton: "Zapisz jako profil",
  transferMarketProfileNameLabel: "Nazwa profilu",
  transferMarketProfileNamePlaceholder: "np. bramkarze perspektywiczni",
  transferMarketSaveProfileTitle: "Zapisz profil wyszukiwania",
  transferMarketSaveProfileConfirm: "Zapisz profil",
  transferMarketProfileNameRequired: "Podaj nazwe profilu.",
  transferMarketOverwriteProfileTitle: "Nadpisac profil?",
  transferMarketOverwriteProfileBody: "Profil o nazwie {{name}} juz istnieje. Nadpisac?",
  transferMarketOverwriteProfileConfirm: "Nadpisz",
  transferMarketOverwriteProfileCancel: "Wroc",
  transferMarketProfileSaved: "Profil zapisany.",
  transferMarketProfileOverwritten: "Profil nadpisany.",
  transferMarketPastSearchesTitle: "Poprzednie wyszukiwania",
  transferMarketPastSearchesEmpty: "Brak poprzednich wyszukiwan.",
  ...
  transferSearchSortSkillTradingCandidate: "Kandydat do skill tradingu",
  ...
  teamSpiritLoadingLeagueFixtures: "Wczytywanie terminarza ligi...",
  teamSpiritLoadingTeamDetails: "Wczytywanie szczegolow zespolu...",
  teamSpiritLoadingDetails: "Wczytywanie szczegolow zakonczonych meczow...",
  teamSpiritLoadingClub: "Wczytywanie sztabu klubu...",
  teamSpiritNoMatches: "Nie znaleziono meczow team spirit w tym sezonie.",
  teamSpiritLoadArchiveFailed: "Nie mozna wczytac meczow team spirit.",
  teamSpiritLoadLeagueFixturesFailed: "Nie mozna wczytac terminarza ligi.",
  teamSpiritLoadTeamDetailsFailed: "Nie mozna wczytac szczegolow zespolu.",
  teamSpiritLoadClubFailed: "Nie mozna wczytac sztabu klubu.",
  teamSpiritLoadMatchDetailsFailed: "Nie mozna wczytac szczegolow meczu",
  teamSpiritSeasonUnknown:
    "Nie mozna ustalic obecnego sezonu. Mecze team spirit nie moga jeszcze zostac wczytane.",
  teamSpiritCoachLeadershipDefaultWarning:
    "Nie mozna ustalic przywodztwa trenera, uzywane jest weak.",
  teamSpiritFetchedPsychologistLevel: "Wczytany poziom psychologa sportowego: {{level}}.",
  ...
  teamSpiritBefore: "Przed",
  teamSpiritBeforeMatch: "TS przed meczem",
  ...
  teamSpiritAfterMatch: "TS po meczu",
  teamSpiritRecoveryBeforeNext: "Regeneracja przed nastepnym meczem TS",
  teamSpiritDailyUpdates: "{{count}} dziennych aktualizacji",
  teamSpiritAfterRecovery: "Po regeneracji",
  teamSpiritMissingTeamAttitude: "Brak nastawienia zespolu",
  teamSpiritCalculationUncertain: "Obliczenie niepewne od tego meczu.",
  teamSpiritCalculationUnavailable: "Niedostepne",
  teamSpiritUnavailableMatchInProgress: "Niedostepne, mecz jest w toku",
  teamSpiritCalculatedUnavailableMatchInProgress:
    "Obliczone TS niedostepne, bo mecz jest w toku",
  teamSpiritCalculationUnavailableMatchInProgress:
    "Obliczenie niedostepne, bo mecz jest w toku.",
  ...
  seniorOtherOrdersSubstitutionsNone: "Brak zaplanowanych zmian.",
  seniorOtherOrdersPenaltyTakersTitle: "Wykonawcy karnych",
  seniorOtherOrdersPenaltyTakersNone: "Brak kolejności wykonawców karnych.",
  seniorOtherOrdersCaptainTitle: "Kapitan",
  seniorOtherOrdersCoachPick: "Wybór trenera",
  seniorOtherOrdersSetPiecesTitle: "Stałe fragmenty",
  seniorOtherOrdersMinuteLabel: "Minuta",
  seniorOtherOrdersPlayerInLabel: "Wchodzi",
  seniorOtherOrdersPlayerOutLabel: "Schodzi",
  seniorOtherOrdersOrderTypeLabel: "Polecenie",
  seniorOtherOrdersReplaceLabel: "Zastąp",
  seniorOtherOrdersSwapLabel: "Zamień",
  seniorOtherOrdersRepositionLabel: "Przestaw",
  seniorOtherOrdersUnknownOrderLabel: "Nieznane",
  seniorOtherOrdersSpecialOrderLabel: "Specjalne",
  seniorOtherOrdersConditionsLabel: "Warunki",
  seniorOtherOrdersCardLabel: "Kartki",
  seniorOtherOrdersStandingLabel: "Wynik",
  ...
  seniorOtherOrdersNoStartingXiPlayers: "Brak dostepnych graczy z pierwszej jedenastki",
  seniorOtherOrdersNoBenchPlayers: "Brak dostepnych rezerwowych",
  ...
  seniorOtherOrdersDeprecatedRedCardCriterion:
    "Przestarzale kryterium czerwonej kartki",
  ...
  seniorOtherOrdersManMarkingNoOpponent:
    "Wybierz mecz przed wybraniem celu krycia indywidualnego.",
  seniorOtherOrdersOpponentPlayersLoading: "Ladowanie zawodnikow rywala...",
  ...
  seniorOtherOrdersManMarkingMarkerPlaceholder: "Wybierz kryjącego",
  ...
  seniorOtherOrdersUnknownOpponentPlayer: "Zawodnik {{playerId}}",
    ...
    seniorOtherOrdersManMarkingAlternativesTitle: "Rozważone alternatywy",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Ocena celu",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Ocena kryjącego",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Ocena pary",
    seniorOtherOrdersManMarkingLimitationsTitle: "Ważne ograniczenia",
    seniorOtherOrdersManMarkingLoading: "Przygotowywanie oceny krycia...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Nie wybrano obecnie kryjącego.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Nie wybrano obecnie celu.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "Wybrany zawodnik nie gra obecnie na poprawnej pozycji do krycia.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} wystąpił jako {{role}} w {{count}} z {{total}} analizowanych meczów ({{percent}}), poniżej wymaganego progu spójności {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} grał głównie jako {{role}}, co nie jest dozwoloną pozycją celu dla krycia indywidualnego.",
    ...
    seniorOtherOrdersManMarkingTargetRoleUnknown: "Nie udało się ustalić oczekiwanej pozycji celu do krycia na podstawie analizowanej historii.",
    seniorOtherOrdersManMarkingNoHistory: "Dla tego kontekstu meczu nie było użytecznej historii przeciwnika.",
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Żadna oceniona para nie miała dodatniej szacowanej korzyści netto.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Najlepsza oceniona para niedodatnia:",
    seniorOtherOrdersManMarkingPositiveResult: "Ta para jest pozytywna według modelu krycia aplikacji.",
    seniorOtherOrdersManMarkingNeutralResult: "Ta para jest w przybliżeniu neutralna według modelu krycia aplikacji.",
    seniorOtherOrdersManMarkingNegativeResult: "Ta para jest negatywna według modelu krycia aplikacji.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Ta ocena zakłada, że przeciwnik wystawi wskazanego zawodnika na oczekiwanej pozycji. Opiera się na wcześniejszych ustawieniach i szacowanych danych zawodników. Przeciwnik może użyć innego zawodnika, formacji, pozycji, zmiany lub planu taktycznego; wtedy polecenie krycia może być mniej skuteczne albo nie zadziałać zgodnie z oczekiwaniem. Umiejętności przeciwnika i pokazane efekty są szacunkami, a nie gwarantowanymi wynikami silnika meczowego. Hattrick Alchemy nie może przewidzieć nieoczekiwanych decyzji przeciwnika i nie ponosi odpowiedzialności za wynik meczu. Sprawdź ostateczne polecenie przed wysłaniem.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Ten wniosek opiera się wyłącznie na dostępnych danych historycznych i szacunkowych. Brak wskazanego celu nie dowodzi, że odpowiedni cel nie istnieje, a niepozytywna estymacja nie gwarantuje, że krycie zawiodłoby przeciw rzeczywistemu przyszłemu ustawieniu przeciwnika. Przeciwnik może zachować się inaczej niż w poprzednich meczach.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "środkowy obrońca",
    seniorOtherOrdersManMarkingRoleWingback: "boczny obrońca",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "środkowy pomocnik",
    seniorOtherOrdersManMarkingRoleForward: "napastnik",
    seniorOtherOrdersManMarkingRoleWinger: "skrzydłowy",
    seniorOtherOrdersManMarkingRecommendationSummary: "Ta para miała najwyższą dodatnią szacowaną korzyść netto spośród {{count}} poprawnie ocenionych par.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Wybrana para",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Ta analiza dotyczy aktualnie wybranego kryjącego i celu.",
    seniorOtherOrdersManMarkingTargetConsistency: "Oczekiwana rola: {{role}}. Zawodnik wystąpił tam w {{count}} z {{total}} analizowanych meczów ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Szacowana surowa główna umiejętność",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Szacowana efektywna główna umiejętność",
    seniorOtherOrdersManMarkingSpecialty: "Specjalność",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Mnożnik porównania celu",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Skorygowana siła porównania celu",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "Cel jest wybrany jako część najlepszej pełnej pary, niekoniecznie dlatego, że ma najwyższą indywidualną estymację.",
    seniorOtherOrdersManMarkingMarkerSummary: "Kryjący gra jako {{role}} z efektywną Obroną {{defending}}, skorygowaną siłą krycia {{adjusted}} i szacowaną normalną wartością pozycji {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Specjalność: {{specialty}}. Mnożnik porównania krycia: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Zneutralizowany szacowany wkład głównej umiejętności celu",
    seniorOtherOrdersManMarkingTargetRetained: "Pozostały szacowany wkład głównej umiejętności celu",
    seniorOtherOrdersManMarkingMarkerPenalty: "Zmniejszenie normalnego wkładu pozycyjnego kryjącego",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Ponieważ {{markerRole}} i {{targetRole}} tworzą bliską parę ról, szacuje się, że krycie indywidualne zmniejsza normalny wkład pozycyjny kryjącego o {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Ponieważ {{markerRole}} i {{targetRole}} nie tworzą bliskiej pary ról, szacuje się, że krycie indywidualne zmniejsza normalny wkład pozycyjny kryjącego o {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Następna najlepsza korzyść netto: {{net}}. To o {{difference}} mniej niż w rekomendowanej parze.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Następna najlepsza korzyść netto: {{net}}. To praktycznie tyle samo co w rekomendowanej parze.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Następna najlepsza korzyść netto: {{net}}. To o {{difference}} więcej niż w rekomendowanej parze.",
    seniorOtherOrdersManMarkingValidTargets: "Dostępne są poprawne estymacje celów.",
    seniorOtherOrdersManMarkingValidMarkers: "Dostępni są poprawni kandydaci do krycia.",
    seniorOtherOrdersManMarkingEffectiveDefending: "efektywna Obrona",
    seniorOtherOrdersManMarkingAdjustedStrength: "skorygowana siła",
    seniorOtherOrdersManMarkingNormalRoleValue: "normalna wartość roli",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "Nie udało się rozpoznać {{player}} jako własnego zawodnika.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} nie ma dostępnej efektywnej Obrony.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} ma niepoprawną lub niedodatnią efektywną Obronę.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} nie ma dostępnej normalnej wartości pozycji.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} ma niepoprawną lub niedodatnią normalną wartość pozycji.",
  ...
  seniorOtherOrdersBehaviourNormal: "Normalne",
  seniorOtherOrdersBehaviourOffensive: "Ofensywne",
  seniorOtherOrdersBehaviourDefensive: "Defensywne",
  seniorOtherOrdersBehaviourTowardsMiddle: "Do srodka",
  seniorOtherOrdersBehaviourTowardsWing: "Do skrzydla",
  seniorOtherOrdersBehaviourExtraForward: "Dodatkowy napastnik",
  seniorOtherOrdersBehaviourExtraInnerMidfield: "Dodatkowy srodkowy pomocnik",
  seniorOtherOrdersBehaviourExtraDefender: "Dodatkowy obronca",
  ...
  analyzeOpponentResultColumn: "Wynik",
  analyzeOpponentResultWin: "Wygrana",
  analyzeOpponentResultLoss: "Porazka",
  analyzeOpponentResultDraw: "Remis",
  ...
  clubChronicleHelpBulletTeamAttitude:
    "Team Attitude wykorzystuje najczestsza formacje, porownuje HatStats z meczow ligowych w tej samej formacji osobno dla domu i wyjazdu, i oznacza mecze prawdopodobnie PIC, MOTS albo normalne. Etykiety potencjalne uzywaja bazowego skladu tylko z ligi, blisko normalnego poziomu HatStats dla danego boiska.",
  ...
  clubChronicleTeamAttitudeDebugBaselineValuesLabel: "Wszystkie wartosci HatStats",
  ...
  clubChronicleTeamAttitudeDetailsDisclaimer:
    "Wywnioskowane nastawienie to heurystyczna ocena oparta na odchyleniach HatStats. Ta tabela pokazuje mecze uzyte do wnioskowania: mecze rozegrane najdominujaca formacja ({formation}) oraz ukladem zawodnikow reprezentatywnym dla skladu ligowego.",
