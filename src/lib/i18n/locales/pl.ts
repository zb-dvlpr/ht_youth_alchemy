...
export const messagesPl: Messages = {
  ...
  seniorOtherOrdersMarkerLabel: "Deckender Spieler",
  seniorOtherOrdersTargetLabel: "Ziel",
  seniorOtherOrdersOpponentIdPlaceholder: "Gegnerische Spieler-ID",
  seniorOtherOrdersCurrentTarget: "Aktuelles Ziel: {{target}}",
  ...
  seniorOtherOrdersUnknownOpponentPlayer: "Zawodnik {{playerId}}",
    ...
    seniorOtherOrdersManMarkingBestRejectedPair: "Najmniej niekorzystna oceniona para:",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "Poniższe obliczenie dotyczy aktualnie wybranej pary.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Usunięty wpływ na wkład",
    seniorOtherOrdersManMarkingTargetRetained: "Pozostały wpływ na wkład",
    seniorOtherOrdersManMarkingMarkerPenalty: "Kara własna kryjącego",
