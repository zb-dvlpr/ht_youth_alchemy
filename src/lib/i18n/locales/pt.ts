...
export const messagesPt: Messages = {
    ...
    seniorTransferSearchPriceRangeLabel: "Preco (display currency)",
    ...
    seniorTransferSearchBidAmountLabel: "Valor do lance (display currency)",
    seniorTransferSearchMaxBidAmountLabel: "Lance maximo (display currency)",
    ...
    seniorFoxtrickSimulationWageLabel: "Salario (display currency)",
