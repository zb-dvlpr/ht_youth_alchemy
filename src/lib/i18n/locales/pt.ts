...
export const messagesPt: Messages = {
    ...
    teamSpiritSeasonStartsAtComposed:
      "A temporada sempre começa com um valor de espírito de equipe de 4.5 (content).",
