...
export const messagesPt: Messages = {
    ...
    clubChronicleHelpBulletFinance:
      "Saldo de transferencias: numero de compras, numero de vendas e saldo em EUR. Clique em uma linha para ver o detalhamento.",
    ...
    seniorOtherOrdersTooltip:
      "Inspecione as outras ordens da escalação desta partida.",
    seniorOtherOrdersDisabledTooltip:
      "Defina ou carregue uma escalação para uma partida específica para inspecionar outras ordens.",
    ...
    seniorTransferSearchPriceRangeLabel: "Preco (EUR)",
