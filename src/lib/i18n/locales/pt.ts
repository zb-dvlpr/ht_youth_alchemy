...
export const messagesPt: Messages = {
    ...
    helpMenuYouTubeChannel: "Canal do YouTube",
    youtubeWatchRelatedVideo: "Ver o vídeo relacionado",
    youtubePlayerTitle: "Vídeo do YouTube",
    youtubePlayerClose: "Fechar vídeo",
    youtubePlayerMinimize: "Minimizar vídeo",
    youtubePlayerRestore: "Restaurar vídeo",
    youtubePlayerOpenExternal: "Abrir no YouTube",
    youtubePlayerAdjust: "Mover ou redimensionar o vídeo",
    youtubePlayerDoneAdjusting: "Concluído",
    ...
    settingsAutoRefreshTitle: "Atualização automática",
    ...
    settingsSeniorPredictedRatingsTitle: "Classificações previstas",
    settingsSeniorPredictedRatingsExperimentalLabel: "Experimental",
    settingsSeniorPredictedRatingsToggleLabel: "Ativar classificações previstas",
    settingsSeniorPredictedRatingsDescription: "Esta funcionalidade é experimental porque o CHPP atualmente devolve valores incorretos para classificações previstas de jogo. Ative-a apenas se ainda considerar a funcionalidade útil. Considere comunicar o problema através de Hattrick Staff Messages e mencionar que o endpoint matchorders devolve valores incorretos quando chamado com predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Relatório de erro",
    settingsSeniorPredictedRatingsReportText: "Assunto: Classificações previstas incorretas devolvidas pelo endpoint CHPP matchorders\n\nOlá,\n\nO endpoint CHPP matchorders parece devolver valores incorretos quando as classificações previstas são pedidas usando predictratings=true.\n\nAs classificações por setor devolvidas não correspondem às classificações esperadas para a escalação, ordens dos jogadores, tática, atitude de jogo e contexto do jogo selecionados. Isto impede as aplicações CHPP de fornecerem classificações previstas de jogo fiáveis.\n\nPodem investigar o cálculo das classificações previstas ou a resposta devolvida pelo endpoint matchorders?\n\nObrigado.",
    settingsSeniorPredictedRatingsCopyReportButton: "Copiar relatório",
    settingsSeniorPredictedRatingsReportButton: "Reportar",
    settingsSeniorPredictedRatingsReportCopied: "Relatório copiado.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Não foi possível copiar o relatório. Selecione e copie o texto manualmente.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Relatório de erro preparado sobre classificações previstas",
    ...
    teamScoutDetailInfoButtonLabel: "Informações de observação da equipa",
    teamScoutInferredTrainingLabel: "Treino inferido: {{training}}",
    teamScoutDataMatchesLabel: "Dados: {{count}} jogos",
    teamScoutDataMatchLabel: "Dados: {{count}} jogo",
    ...
    teamSpiritCurrentTeamSpiritTooltip:
      "Substitua este valor manualmente se seu espírito de equipe foi afetado por uma venda de jogador. Esta informação não esta disponível via CHPP.",
    teamSpiritCurrentTeamSpiritInfoAria: "Informação do espírito de equipe atual",
    ...
    teamSpiritManuallyOverridden: "Substituido manualmente",
    teamSpiritReset: "Redefinir",
    teamSpiritCoachLeadership: "Liderança do treinador",
    teamSpiritCoachLeadershipActual: "Detectado: {{leadership}}",
    teamSpiritCoachLeadershipTooltip:
      "Substitua este valor para ver como outro nivel de liderança do treinador afetaria o espírito de equipe.",
    teamSpiritCoachLeadershipInfoAria: "Sobre substituições da liderança do treinador",
    ...
    teamSpiritSportsPsychologistTooltip:
      "Mesmo que seu time não tenha psicólogo esportivo, você pode simular um para ver seu efeito no espírito de equipe.",
    teamSpiritSportsPsychologistInfoAria: "Sobre simulação de psicólogo esportivo",
    teamSpiritSportsPsychologistLevelDetected: "Detectado: {{level}}",
    teamSpiritNoSportsPsychologistDetected: "Nenhum psicólogo esportivo detectado.",
    ...
    teamSpiritLoadingLeagueFixtures: "Carregando calendario da liga...",
    teamSpiritLoadingTeamDetails: "Carregando detalhes da equipe...",
    teamSpiritLoadingDetails: "Carregando detalhes de partidas concluídas...",
    teamSpiritLoadingClub: "Carregando equipe do clube...",
    teamSpiritNoMatches: "Nenhuma partida de espirito de equipe encontrada nesta temporada.",
    teamSpiritLoadArchiveFailed: "Não foi possível carregar partidas de espirito de equipe.",
    teamSpiritLoadLeagueFixturesFailed: "Não foi possível carregar o calendario da liga.",
    teamSpiritLoadTeamDetailsFailed: "Não foi possível carregar os detalhes da equipe.",
    teamSpiritLoadClubFailed: "Não foi possível carregar a equipe do clube.",
    teamSpiritLoadMatchDetailsFailed: "Não foi possível carregar detalhes da partida",
    teamSpiritSeasonUnknown:
      "Não foi possível determinar a temporada atual. Partidas de espirito de equipe ainda não podem ser carregadas.",
    teamSpiritCoachLeadershipDefaultWarning:
      "A liderança do treinador não pôde ser determinada, então weak é usado.",
    teamSpiritFetchedPsychologistLevel: "Nível do psicólogo esportivo carregado: {{level}}.",
    ...
    teamSpiritBeforeMatch: "TS antes da partida",
    teamSpiritBeforeMatchTooltip:
      "Substitua este valor manualmente se seu espírito de equipe foi afetado por uma venda de jogador. Esta informação não esta disponível via CHPP.",
    teamSpiritBeforeMatchInfoAria: "Informação de TS antes da partida",
    teamSpiritCalculatedSeasonStart:
      "O espírito de equipe inicial calculado para a temporada e {{value}} ({{level}}), com base no nível do psicólogo esportivo {{psychologistLevel}}.",
    teamSpiritMidfield: "Meio-campo",
    teamSpiritMidfieldIfYou: "se voce ...",
    teamSpiritMidfieldPerformance: "desempenho do meio-campo",
    teamSpiritAfterMatch: "TS depois da partida",
    teamSpiritRecoveryBeforeNext: "Recuperação antes da próxima partida TS",
    teamSpiritDailyUpdates: "{{count}} atualizações diárias",
    teamSpiritAfterRecovery: "Depois da recuperação",
    teamSpiritMissingTeamAttitude: "Atitude da equipe ausente",
    teamSpiritCalculationUncertain: "Cálculo incerto a partir desta partida.",
    teamSpiritCalculationUnavailable: "Indisponível",
    teamSpiritUnavailableMatchInProgress: "Indisponível enquanto a partida esta em andamento",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "TS calculado indisponível porque uma partida esta em andamento",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Calculo indisponível porque uma partida esta em andamento.",
    ...
    optimizeRevealNoSafeGoalkeeper:
      "Não é possível escalar nenhum guarda-redes elegível sem comprometer a revelação solicitada.",
    optimizeRevealAmbiguousPrimary:
      "O jogador selecionado tem mais do que um valor atual oculto neste treino combinado, por isso não é possível garantir uma revelação específica.",
    optimizeRevealAmbiguousSecondary:
      "O jogador selecionado tem mais do que um valor máximo oculto neste treino combinado, por isso não é possível garantir uma revelação específica.",
    optimizeRevealNoSafeTargetPlacement:
      "Os alvos de revelação selecionados não podem ser colocados em posições de treino sem comprometer uma das revelações solicitadas.",
    ...
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Escolher marcador",
    seniorOtherOrdersManMarkingTargetPlaceholder: "Escolher alvo",
    seniorOtherOrdersUnknownOpponentPlayer: "Jogador {{playerId}}",
    seniorOtherOrdersManMarkingExplanationTitle: "Explicação da marcação individual",
    seniorOtherOrdersManMarkingRecommendationTitle: "Recomendação",
    seniorOtherOrdersManMarkingSourceRecommended: "Recomendação do algoritmo",
    seniorOtherOrdersManMarkingSourceNoRecommendation: "Sem recomendação",
    seniorOtherOrdersManMarkingSourceManual: "Seleção manual",
    seniorOtherOrdersManMarkingSourceLoaded: "Ordem carregada",
    seniorOtherOrdersManMarkingSourceModifiedRecommendation:
      "Alterado face à recomendação do algoritmo",
    seniorOtherOrdersManMarkingSourceModifiedLoaded: "Ordem carregada alterada",
    seniorOtherOrdersManMarkingWhyTargetTitle: "Porquê este alvo",
    seniorOtherOrdersManMarkingWhyMarkerTitle: "Porquê este marcador",
    seniorOtherOrdersManMarkingExpectedEffectTitle: "Efeito esperado no jogo",
    seniorOtherOrdersManMarkingAlternativesTitle: "Alternativas consideradas",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Avaliação do alvo",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Avaliação do marcador",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Avaliação do par",
    seniorOtherOrdersManMarkingLimitationsTitle: "Limitações importantes",
    seniorOtherOrdersManMarkingLoading: "A preparar avaliação da marcação...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Nenhum marcador está selecionado.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Nenhum alvo está selecionado.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "O jogador selecionado não está atualmente numa posição válida para marcar.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} apareceu como {{role}} em {{count}} de {{total}} jogos analisados ({{percent}}), abaixo do limiar de consistência exigido de {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} jogou predominantemente como {{role}}, que não é uma posição de alvo elegível para marcação individual.",
    seniorOtherOrdersManMarkingTargetAmbiguousPredominant: "{{player}} não teve uma posição predominante única nos jogos analisados.",
    seniorOtherOrdersManMarkingTargetNotObserved: "{{player}} não foi observado nas formações iniciais analisadas em {{total}} jogos analisados.",
    seniorOtherOrdersManMarkingTargetInvalidSave: "Escolhe um candidato a alvo elegível antes de guardar a ordem de marcação individual.",
    seniorOtherOrdersManMarkingTargetContextUnavailable:
      "Não foi possível verificar os candidatos a alvo para este jogo. Tenta novamente antes de guardar a ordem de marcação individual.",
    seniorOtherOrdersManMarkingMarkerInvalidSave: "Escolhe um candidato a marcador elegível antes de guardar a ordem de marcação individual.",
    seniorOtherOrdersManMarkingMarkerIneligibleCurrentPosition: "O marcador selecionado está no onze inicial, mas não joga como defesa central, lateral ou médio interior.",
    seniorOtherOrdersManMarkingMarkerNotStarting: "O marcador selecionado não está no onze inicial atual.",
    seniorOtherOrdersManMarkingTargetRoleUnknown: "Não foi possível determinar a posição marcável esperada do alvo a partir do histórico analisado.",
    seniorOtherOrdersManMarkingNoHistory: "Não havia histórico útil do adversário para este contexto de jogo.",
    seniorOtherOrdersManMarkingNoConsistentTarget: "Nenhum avançado, extremo ou médio interior atingiu o limite de consistência configurado.",
    seniorOtherOrdersManMarkingTargetDetailsUnavailable: "Existiam candidatos históricos, mas não foi possível carregar os detalhes do alvo.",
    seniorOtherOrdersManMarkingTargetEstimateUnavailable: "Os detalhes do alvo estavam disponíveis, mas não foi possível produzir uma habilidade principal efetiva estimada utilizável.",
    seniorOtherOrdersManMarkingTargetFailuresIntro:
      "{{count}} candidatos a alvo consistentes não produziram uma estimativa efetiva utilizável da habilidade principal:",
    seniorOtherOrdersManMarkingTargetFailureConsistency:
      "{{player}} apareceu como {{role}} em {{count}} de {{total}} jogos analisados ({{percent}}).",
    ...
    seniorOtherOrdersManMarkingTargetFailureSalary:
      "Não havia salário utilizável para a estimativa de {{skill}} baseada no salário.",
    seniorOtherOrdersManMarkingTargetFailureAge:
      "A idade do jogador estava indisponível, por isso a estimativa de {{skill}} baseada no salário não pôde ser calculada.",
    seniorOtherOrdersManMarkingTargetFailureTooOld:
      "O modelo de estimativa salarial não suporta jogadores desta idade.",
    seniorOtherOrdersManMarkingTargetFailureRawEstimate:
      "Os dados salariais disponíveis não produziram uma estimativa utilizável de {{skill}}.",
    seniorOtherOrdersManMarkingTargetFailureForm:
      "Foi produzida uma estimativa bruta de {{skill}} de {{rawSkill}}, mas a forma estava indisponível.",
    seniorOtherOrdersManMarkingTargetFailureStamina:
      "Foi produzida uma estimativa bruta de {{skill}} de {{rawSkill}}, mas a resistência estava indisponível.",
    seniorOtherOrdersManMarkingTargetFailureEffective:
      "Foi produzida uma estimativa bruta de {{skill}} de {{rawSkill}}, mas o cálculo efetivo não produziu um resultado utilizável.",
    seniorOtherOrdersManMarkingTargetSalaryUnavailable:
      "Os detalhes do alvo estavam disponíveis, mas faltavam dados de salário.",
    seniorOtherOrdersManMarkingTargetAgeUnavailable:
      "Os detalhes do alvo estavam disponíveis, mas faltavam dados de idade.",
    seniorOtherOrdersManMarkingTargetTooOld:
      "Os detalhes do alvo estavam disponíveis, mas o jogador está fora do intervalo de idade suportado pelo modelo salarial.",
    seniorOtherOrdersManMarkingTargetRawEstimateUnavailable:
      "Os detalhes do alvo estavam disponíveis, mas não foi possível produzir uma estimativa bruta da habilidade principal com base no salário.",
    seniorOtherOrdersManMarkingTargetFormUnavailable:
      "Os detalhes do alvo estavam disponíveis, mas faltavam dados de forma.",
    seniorOtherOrdersManMarkingTargetStaminaUnavailable:
      "Os detalhes do alvo estavam disponíveis, mas faltavam dados de resistência.",
    seniorOtherOrdersManMarkingTargetEffectiveUnavailable:
      "Foi produzida uma estimativa bruta da habilidade principal, mas não foi possível convertê-la numa habilidade principal efetiva estimada.",
    seniorOtherOrdersManMarkingNoEligibleMarker: "Nenhum defesa central, defesa lateral ou médio interior elegível está atualmente no onze inicial.",
    seniorOtherOrdersManMarkingMarkerDataUnavailable: "Existem posições elegíveis, mas não foi possível calcular a Defesa efetiva ou o valor normal da posição.",
    seniorOtherOrdersManMarkingNoPositivePair: "Nenhum par avaliado teve benefício líquido estimado positivo.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Melhor par avaliado não positivo:",
    seniorOtherOrdersManMarkingPositiveResult: "Este par é positivo no modelo de marcação da app.",
    seniorOtherOrdersManMarkingNeutralResult: "Este par é aproximadamente neutro no modelo de marcação da app.",
    seniorOtherOrdersManMarkingNegativeResult: "Este par é negativo no modelo de marcação da app.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Esta avaliação assume que o adversário coloca o jogador identificado na posição esperada. Baseia-se em alinhamentos anteriores e dados estimados dos jogadores. O adversário pode usar outro jogador, formação, posição, substituição ou plano tático; nesse caso a ordem pode ser menos eficaz ou não ativar como esperado. As habilidades adversárias e os efeitos apresentados são estimativas, não resultados garantidos do motor de jogo. O Hattrick Alchemy não consegue prever decisões inesperadas do adversário e não aceita responsabilidade pelo resultado. Revê a ordem final antes de a enviar.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Esta conclusão baseia-se apenas nos dados históricos e estimados disponíveis. Não identificar um alvo não prova que não exista um alvo adequado, e uma estimativa não positiva não garante que a marcação falharia contra o futuro alinhamento real do adversário. O adversário pode agir de forma diferente dos jogos anteriores.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "defesa central",
    seniorOtherOrdersManMarkingRoleWingback: "defesa lateral",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "médio interior",
    seniorOtherOrdersManMarkingRoleForward: "avançado",
    seniorOtherOrdersManMarkingRoleWinger: "extremo",
    seniorOtherOrdersManMarkingRecommendationSummary: "Este par teve o maior benefício líquido estimado positivo entre {{count}} pares válidos avaliados.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Par selecionado",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Esta análise aplica-se ao marcador e ao alvo atualmente selecionados.",
    seniorOtherOrdersManMarkingTargetConsistency: "Papel esperado: {{role}}. O jogador apareceu aí em {{count}} de {{total}} jogos analisados ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Habilidade principal bruta estimada",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Habilidade principal efetiva estimada",
    seniorOtherOrdersManMarkingSpecialty: "Especialidade",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Multiplicador de comparação do alvo",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Força de comparação ajustada do alvo",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "O alvo é escolhido como parte do melhor par completo, não necessariamente por ter a maior estimativa individual.",
    seniorOtherOrdersManMarkingMarkerSummary: "O marcador joga como {{role}} com Defesa efetiva {{defending}}, força ajustada {{adjusted}} e valor posicional normal estimado {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Especialidade: {{specialty}}. Multiplicador de comparação da marcação: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Contribuição estimada da habilidade principal do alvo neutralizada",
    seniorOtherOrdersManMarkingTargetRetained: "Contribuição estimada da habilidade principal do alvo restante",
    seniorOtherOrdersManMarkingMarkerPenalty: "Redução da contribuição posicional normal do marcador",
    seniorOtherOrdersManMarkingTargetValueRemoved: "Valor estimado removido do alvo",
    seniorOtherOrdersManMarkingMarkerValueLost: "Valor estimado perdido pelo marcador",
    seniorOtherOrdersManMarkingNetBenefit: "Benefício líquido estimado",
    seniorOtherOrdersManMarkingTargetNameLoading: "A carregar nome do alvo...",
    seniorOtherOrdersManMarkingClosePenaltyReason: "Como {{markerRole}} e {{targetRole}} formam um par de funções próximo, estima-se que a marcação individual reduza a contribuição posicional normal do marcador em {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Como {{markerRole}} e {{targetRole}} não formam um par de funções próximo, estima-se que a marcação individual reduza a contribuição posicional normal do marcador em {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Benefício líquido seguinte: {{net}}. Isto é {{difference}} inferior ao par recomendado.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Benefício líquido seguinte: {{net}}. Isto é efetivamente igual ao par recomendado.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Benefício líquido seguinte: {{net}}. Isto é {{difference}} superior ao par recomendado.",
    seniorOtherOrdersManMarkingValidTargets: "Há estimativas válidas de alvos disponíveis.",
    seniorOtherOrdersManMarkingValidMarkers: "Há candidatos válidos a marcador disponíveis.",
    seniorOtherOrdersManMarkingEffectiveDefending: "Defesa efetiva",
    seniorOtherOrdersManMarkingAdjustedStrength: "força ajustada",
    seniorOtherOrdersManMarkingNormalRoleValue: "valor normal do papel",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} não pôde ser resolvido como jogador próprio.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} não tem valor de Defesa efetiva disponível.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} tem Defesa efetiva inválida ou não positiva.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} não tem valor posicional normal disponível.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} tem valor posicional normal inválido ou não positivo.",
    ...
    analyzeOpponentMatchColumn: "Partida",
    analyzeOpponentResultColumn: "Resultado",
    analyzeOpponentResultWin: "Vitoria",
    analyzeOpponentResultLoss: "Derrota",
    analyzeOpponentResultDraw: "Empate",
    ...
    analyzeOpponentMatchFallback: "Partida {{matchId}}",
    ...
    seniorOpponentAnalysisTabMatches: "Partidas",
    seniorOpponentAnalysisTabScoutTeam: "Observar equipa",
    seniorOpponentScoutTeamLoading: "A carregar analise do elenco adversario...",
    seniorOpponentScoutTeamError: "Nao foi possivel carregar a analise do elenco adversario.",
    seniorOpponentScoutTeamEmpty: "Nenhum dado do elenco adversario disponivel.",
    ...
    trainingScoringAndSetPieces: "Finalização e bolas paradas",
