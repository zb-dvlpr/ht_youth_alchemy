...
export const messagesPt: Messages = {
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Foram encontrados marcadores e alvos válidos, mas todos os pares avaliados tinham benefício líquido estimado zero ou negativo.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Par avaliado menos desfavorável:",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "O cálculo abaixo aplica-se ao par atualmente selecionado.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Contribuição afetada removida",
    seniorOtherOrdersManMarkingTargetRetained: "Contribuição afetada mantida",
    seniorOtherOrdersManMarkingMarkerPenalty: "Penalização própria do marcador",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "A penalização de 50% aplica-se porque marcador e alvo formam um par de papéis próximo.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "A penalização de 65% aplica-se porque estes papéis não formam um par próximo.",
