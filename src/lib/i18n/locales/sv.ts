...
export const messagesSv: Messages = {
    ...
    feedbackBugTitle: "Buggrapport",
    feedbackFeatureTitle: "Funktionsförslag",
    feedbackFieldTitle: "Titel",
    feedbackFieldProblem: "Vad är problemet?",
    feedbackFieldReproduce: "Hur reproduceras det?",
    feedbackFieldExpected: "Förväntat beteende",
    feedbackFieldActual: "Faktiskt beteende",
    feedbackFieldProposed: "Föreslagen lösning",
    feedbackFieldAlternatives: "Övervägda alternativ",
    feedbackFieldNotes: "Extra anteckningar",
    feedbackBugTitlePlaceholder: "Kort sammanfattning av buggen",
    feedbackFeatureTitlePlaceholder: "Kort sammanfattning av funktionen",
    feedbackFieldProblemPlaceholder: "Beskriv problemet eller sammanhanget",
    feedbackFieldReproducePlaceholder:
      "Lista stegen som utlöser problemet",
    feedbackFieldExpectedPlaceholder: "Vad borde ha hänt?",
    feedbackFieldActualPlaceholder: "Vad hände i stället?",
    feedbackFieldProposedPlaceholder: "Beskriv ändringen du vill ha",
    feedbackFieldAlternativesPlaceholder:
      "Lista andra angreppssätt du övervägde",
    feedbackFieldNotesPlaceholder: "Allt annat som är värt att ta med",
    feedbackTitleRequired: "Titel krävs.",
    feedbackSubmit: "Skicka",
    feedbackSubmitting: "Skickar…",
    ...
    lineupSlotLeftWingBack: "Vänster ytterback",
    lineupSlotRightWingBack: "Höger ytterback",
    lineupSlotLeftCentralDefender: "Vänster mittback",
    lineupSlotCentralDefender: "Mittback",
    lineupSlotRightCentralDefender: "Höger mittback",
    lineupSlotLeftWinger: "Vänster ytter",
    lineupSlotRightWinger: "Höger ytter",
    lineupSlotLeftInnerMidfield: "Vänster mittfältare",
    lineupSlotCentralInnerMidfield: "Central mittfältare",
    lineupSlotRightInnerMidfield: "Höger mittfältare",
    lineupSlotLeftForward: "Vänster forward",
    lineupSlotCentralForward: "Central forward",
    lineupSlotRightForward: "Höger forward",
    lineupSlotBenchKeeper: "Bänkmålvakt",
    lineupSlotBenchCentralDefender: "Bänkmittback",
    lineupSlotBenchWingBack: "Bänkytterback",
    lineupSlotBenchInnerMidfield: "Bänkmittfältare",
    lineupSlotBenchForward: "Bänkforward",
    lineupSlotBenchWinger: "Bänkytter",
    lineupSlotBenchExtra: "Bänk extra",
