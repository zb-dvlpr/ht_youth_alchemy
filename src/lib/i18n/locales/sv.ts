...
export const messagesSv: Messages = {
    ...
    youtubeWatchRelatedVideo: "Titta på relaterad video",
    youtubePlayerTitle: "YouTube-video",
    youtubePlayerClose: "Stäng videon",
    youtubePlayerMinimize: "Minimera videon",
    youtubePlayerRestore: "Återställ videon",
    youtubePlayerOpenExternal: "Öppna på YouTube",
    youtubePlayerAdjust: "Flytta eller ändra videons storlek",
    youtubePlayerDoneAdjusting: "Klar",
    ...
    toolTransferMarket: "Transfermarknad",
    ...
    settingsAutoRefreshTitle: "Automatisk uppdatering",
    ...
    settingsSeniorPredictedRatingsTitle: "Förväntade betyg",
    settingsSeniorPredictedRatingsExperimentalLabel: "Experimentell",
    settingsSeniorPredictedRatingsToggleLabel: "Aktivera förväntade betyg",
    settingsSeniorPredictedRatingsDescription: "Den här funktionen är experimentell eftersom CHPP för närvarande returnerar felaktiga värden för förväntade matchbetyg. Aktivera den bara om du ändå tycker att funktionen är användbar. Överväg att rapportera problemet via Hattrick Staff Messages och nämn att matchorders-endpointen returnerar felaktiga värden när den anropas med predictratings=true.",
    settingsSeniorPredictedRatingsReportLabel: "Felrapport",
    settingsSeniorPredictedRatingsReportText: "Ämne: Felaktiga förväntade betyg returneras av CHPP-endpointen matchorders\n\nHej,\n\nCHPP-endpointen matchorders verkar returnera felaktiga värden när förväntade betyg begärs med predictratings=true.\n\nDe returnerade sektorsbetygen motsvarar inte de förväntade betygen för vald laguppställning, spelarorder, taktik, matchinställning och matchkontext. Detta hindrar CHPP-applikationer från att tillhandahålla tillförlitliga förväntade matchbetyg.\n\nKan ni undersöka beräkningen av förväntade betyg eller svaret som returneras av matchorders-endpointen?\n\nTack.",
    settingsSeniorPredictedRatingsCopyReportButton: "Kopiera rapport",
    settingsSeniorPredictedRatingsReportButton: "Rapportera",
    settingsSeniorPredictedRatingsReportCopied: "Rapporten kopierades.",
    settingsSeniorPredictedRatingsReportCopyFailed: "Det gick inte att kopiera rapporten. Markera och kopiera texten manuellt.",
    settingsSeniorPredictedRatingsReportAriaLabel: "Förberedd felrapport om förväntade betyg",
    ...
    teamSpiritLoadingLeagueFixtures: "Laddar ligaspelschema...",
    teamSpiritLoadingTeamDetails: "Laddar lagdetaljer...",
    teamSpiritLoadingDetails: "Laddar detaljer for spelade matcher...",
    teamSpiritLoadingClub: "Laddar klubbpersonal...",
    teamSpiritNoMatches: "Inga lagandamatcher hittades for denna sasong.",
    teamSpiritLoadArchiveFailed: "Kunde inte ladda lagandamatcher.",
    teamSpiritLoadLeagueFixturesFailed: "Kunde inte ladda ligaspelschema.",
    teamSpiritLoadTeamDetailsFailed: "Kunde inte ladda lagdetaljer.",
    teamSpiritLoadClubFailed: "Kunde inte ladda klubbpersonal.",
    teamSpiritLoadMatchDetailsFailed: "Kunde inte ladda matchdetaljer",
    teamSpiritSeasonUnknown:
      "Kunde inte avgora aktuell sasong. Lagandamatcher kan inte laddas annu.",
    teamSpiritCoachLeadershipDefaultWarning:
      "Tranarens ledarskap kunde inte avgoras, sa weak anvands.",
    teamSpiritFetchedPsychologistLevel: "Hamlad idrottspsykologniva: {{level}}.",
    ...
    teamSpiritCalculatedSeasonStart:
      "Den beraknade startlagandan for sasongen ar {{value}} ({{level}}), baserat pa sportpsykologniva {{psychologistLevel}}.",
    teamSpiritMidfield: "Mittfalt",
    teamSpiritMidfieldIfYou: "om du ...",
    teamSpiritMidfieldPerformance: "mittfaltsprestation",
    teamSpiritAfterMatch: "TS efter match",
    teamSpiritRecoveryBeforeNext: "Aterhamtning fore nasta TS-match",
    teamSpiritDailyUpdates: "{{count}} dagliga uppdateringar",
    teamSpiritAfterRecovery: "Efter aterhamtning",
    teamSpiritMissingTeamAttitude: "Laginstallning saknas",
    teamSpiritCalculationUncertain: "Berakningen ar osaker fran denna match.",
    teamSpiritCalculationUnavailable: "Inte tillgangligt",
    teamSpiritUnavailableMatchInProgress: "Inte tillgangligt medan matchen pagar",
    teamSpiritCalculatedUnavailableMatchInProgress:
      "Beraknad TS inte tillganglig eftersom en match pagar",
    teamSpiritCalculationUnavailableMatchInProgress:
      "Berakning inte tillganglig eftersom en match pagar.",
    ...
    seniorOtherOrdersSubstitutionsNone: "Inga planerade byten.",
    seniorOtherOrdersPenaltyTakersTitle: "Straffläggare",
    seniorOtherOrdersPenaltyTakersNone: "Ingen straffläggarordning.",
    seniorOtherOrdersCaptainTitle: "Kapten",
    seniorOtherOrdersCoachPick: "Tränarens val",
    seniorOtherOrdersSetPiecesTitle: "Fasta situationer",
    seniorOtherOrdersMinuteLabel: "Minut",
    seniorOtherOrdersPlayerInLabel: "In",
    seniorOtherOrdersPlayerOutLabel: "Ut",
    seniorOtherOrdersOrderTypeLabel: "Order",
    seniorOtherOrdersReplaceLabel: "Ersätt",
    seniorOtherOrdersSwapLabel: "Byt",
    seniorOtherOrdersRepositionLabel: "Ompositionera",
    seniorOtherOrdersUnknownOrderLabel: "Okänd",
    seniorOtherOrdersSpecialOrderLabel: "Special",
    seniorOtherOrdersConditionsLabel: "Villkor",
    seniorOtherOrdersCardLabel: "Kort",
    seniorOtherOrdersStandingLabel: "Ställning",
    ...
    seniorOtherOrdersDevTacticalAssistantLevel:
      "Simulerad taktisk assistent-niva: {{level}}",
    ...
    seniorOtherOrdersNoStartingXiPlayers: "Inga startspelare tillgangliga",
    seniorOtherOrdersNoBenchPlayers: "Inga bankspelare tillgangliga",
    ...
    seniorOtherOrdersManMarkingNoOpponent:
      "Valj en match innan du valjer mal for man-markering.",
    seniorOtherOrdersOpponentPlayersLoading: "Laddar motstandarspelare...",
    ...
    seniorOtherOrdersManMarkingMarkerPlaceholder: "Välj markerare",
    ...
    seniorOtherOrdersManMarkingAlternativesTitle: "Alternativ som övervägdes",
    seniorOtherOrdersManMarkingTargetAssessmentTitle: "Målbedömning",
    seniorOtherOrdersManMarkingMarkerAssessmentTitle: "Markeringsbedömning",
    seniorOtherOrdersManMarkingPairAssessmentTitle: "Parbedömning",
    seniorOtherOrdersManMarkingLimitationsTitle: "Viktiga begränsningar",
    seniorOtherOrdersManMarkingLoading: "Förbereder bedömning av man-markering...",
    seniorOtherOrdersManMarkingNoMarkerSelected: "Ingen markerare är vald just nu.",
    seniorOtherOrdersManMarkingNoTargetSelected: "Inget mål är valt just nu.",
    seniorOtherOrdersManMarkingInvalidMarkerPosition: "Den valda spelaren spelar inte på en giltig position för man-markering.",
    seniorOtherOrdersManMarkingTargetBelowFuzziness: "{{player}} spelade som {{role}} i {{count}} av {{total}} analyserade matcher ({{percent}}), under den krävda konsekvenströskeln {{threshold}}.",
    seniorOtherOrdersManMarkingTargetNonMarkablePredominant: "{{player}} spelade främst som {{role}}, vilket inte är en valbar målposition för man-markering.",
    ...
    seniorOtherOrdersManMarkingTargetRoleUnknown: "Målets förväntade markerbara position kunde inte fastställas från den analyserade historiken.",
    seniorOtherOrdersManMarkingNoHistory: "Ingen användbar motståndarhistorik fanns för denna matchkontext.",
    ...
    seniorOtherOrdersManMarkingNoPositivePair: "Inget utvärderat par hade en positiv uppskattad nettofördel.",
    seniorOtherOrdersManMarkingBestRejectedPair: "Bästa utvärderade icke-positiva par:",
    seniorOtherOrdersManMarkingPositiveResult: "Detta par är positivt enligt appens markeringsmodell.",
    seniorOtherOrdersManMarkingNeutralResult: "Detta par är ungefär neutralt enligt appens markeringsmodell.",
    seniorOtherOrdersManMarkingNegativeResult: "Detta par är negativt enligt appens markeringsmodell.",
    seniorOtherOrdersManMarkingRecommendationCaveat: "Denna bedömning antar att motståndaren spelar den identifierade spelaren på den förväntade positionen. Den bygger på tidigare uppställningar och uppskattad spelardata. Motståndaren kan använda en annan spelare, formation, position, avbytare eller taktisk plan; då kan markeringsordern bli mindre effektiv eller inte aktiveras som väntat. Motståndarens färdigheter och visade effekter är uppskattningar, inte garanterade matchmotorresultat. Hattrick Alchemy kan inte förutse oväntade motståndardrag och tar inget ansvar för matchutfallet. Granska den slutliga ordern innan du skickar den.",
    seniorOtherOrdersManMarkingNoRecommendationCaveat: "Denna slutsats bygger endast på tillgänglig historisk och uppskattad data. Att inget mål identifieras bevisar inte att inget lämpligt mål finns, och en icke-positiv uppskattning garanterar inte att man-markering skulle misslyckas mot motståndarens faktiska framtida uppställning. Motståndaren kan agera annorlunda än i tidigare matcher.",
    seniorOtherOrdersManMarkingRoleCentralDefender: "mittback",
    seniorOtherOrdersManMarkingRoleWingback: "ytterback",
    seniorOtherOrdersManMarkingRoleInnerMidfielder: "innermittfältare",
    seniorOtherOrdersManMarkingRoleForward: "forward",
    seniorOtherOrdersManMarkingRoleWinger: "ytter",
    seniorOtherOrdersManMarkingRecommendationSummary: "Detta par hade högst positiv uppskattad nettofördel bland {{count}} giltiga utvärderade par.",
    seniorOtherOrdersManMarkingSelectedPairTitle: "Valt par",
    seniorOtherOrdersManMarkingCurrentPairSummary: "Denna analys gäller den markerare och det mål som är valda just nu.",
    seniorOtherOrdersManMarkingTargetConsistency: "Förväntad roll: {{role}}. Spelaren förekom där i {{count}} av {{total}} analyserade matcher ({{percent}}).",
    seniorOtherOrdersManMarkingEstimatedRawMainSkill: "Uppskattad rå huvudfärdighet",
    seniorOtherOrdersManMarkingEstimatedEffectiveMainSkill: "Uppskattad effektiv huvudfärdighet",
    seniorOtherOrdersManMarkingSpecialty: "Specialitet",
    seniorOtherOrdersManMarkingTargetSpecialtyMultiplier: "Målets jämförelsemultiplikator",
    seniorOtherOrdersManMarkingAdjustedTargetStrength: "Justerad jämförelsestyrka för målet",
    seniorOtherOrdersManMarkingTargetChosenAsPair: "Målet väljs som del av det bästa kompletta paret, inte nödvändigtvis för att han har högst individuell uppskattning.",
    seniorOtherOrdersManMarkingMarkerSummary: "Markeraren spelar som {{role}} med effektivt försvar {{defending}}, justerad markeringsstyrka {{adjusted}} och uppskattat normalt positionsvärde {{normal}}.",
    seniorOtherOrdersManMarkingMarkerSpecialtyEffect: "Specialitet: {{specialty}}. Jämförelsemultiplikator för markering: {{multiplier}}.",
    seniorOtherOrdersManMarkingTargetLoss: "Neutraliserat uppskattat huvudskillsbidrag från målet",
    seniorOtherOrdersManMarkingTargetRetained: "Återstående uppskattat huvudskillsbidrag från målet",
    seniorOtherOrdersManMarkingMarkerPenalty: "Minskning av markerarens normala positionsbidrag",
    ...
    seniorOtherOrdersManMarkingClosePenaltyReason: "Eftersom {{markerRole}} och {{targetRole}} bildar ett nära rollpar uppskattas man-markering minska markerarens normala positionsbidrag med {{penalty}}.",
    seniorOtherOrdersManMarkingDistantPenaltyReason: "Eftersom {{markerRole}} och {{targetRole}} inte bildar ett nära rollpar uppskattas man-markering minska markerarens normala positionsbidrag med {{penalty}}.",
    seniorOtherOrdersManMarkingAlternativeSummaryLower: "Näst bästa nettofördel: {{net}}. Detta är {{difference}} lägre än det rekommenderade paret.",
    seniorOtherOrdersManMarkingAlternativeSummaryEqual: "Näst bästa nettofördel: {{net}}. Detta är i praktiken samma som det rekommenderade paret.",
    seniorOtherOrdersManMarkingAlternativeSummaryHigher: "Näst bästa nettofördel: {{net}}. Detta är {{difference}} högre än det rekommenderade paret.",
    seniorOtherOrdersManMarkingValidTargets: "Giltiga måluppskattningar finns.",
    seniorOtherOrdersManMarkingValidMarkers: "Giltiga markeringskandidater finns.",
    seniorOtherOrdersManMarkingEffectiveDefending: "effektivt försvar",
    seniorOtherOrdersManMarkingAdjustedStrength: "justerad styrka",
    seniorOtherOrdersManMarkingNormalRoleValue: "normalt rollvärde",
    seniorOtherOrdersManMarkingMarkerPlayerUnresolved: "{{player}} kunde inte matchas som egen spelare.",
    seniorOtherOrdersManMarkingMarkerDefendingUnavailable: "{{player}} saknar tillgängligt värde för effektivt försvar.",
    seniorOtherOrdersManMarkingMarkerDefendingInvalid: "{{player}} har ogiltigt eller icke-positivt effektivt försvar.",
    seniorOtherOrdersManMarkingMarkerNormalValueUnavailable: "{{player}} saknar normalt positionsvärde.",
    seniorOtherOrdersManMarkingMarkerNormalValueInvalid: "{{player}} har ogiltigt eller icke-positivt normalt positionsvärde.",
    ...
    seniorOtherOrdersBehaviourTowardsMiddle: "Mot mitten",
    seniorOtherOrdersBehaviourTowardsWing: "Mot kanten",
    seniorOtherOrdersBehaviourExtraForward: "Extra forward",
    seniorOtherOrdersBehaviourExtraInnerMidfield: "Extra innermittfaltare",
    seniorOtherOrdersBehaviourExtraDefender: "Extra forsvarare",
    ...
    transferMarketPastSearchesButton: "Tidigare sokningar",
    transferMarketProfilesTooltip: "Lista sokprofiler",
    transferMarketProfilesAriaLabel: "Lista sokprofiler",
    transferMarketSaveAsProfileButton: "Spara som profil",
    transferMarketProfileNameLabel: "Profilnamn",
    transferMarketProfileNamePlaceholder: "t.ex. malvaktsloften",
    transferMarketSaveProfileTitle: "Spara sokprofil",
    transferMarketSaveProfileConfirm: "Spara profil",
    transferMarketProfileNameRequired: "Ange ett profilnamn.",
    transferMarketOverwriteProfileTitle: "Skriv over profil?",
    transferMarketOverwriteProfileBody: "En profil med namnet {{name}} finns redan. Skriv over den?",
    transferMarketOverwriteProfileConfirm: "Skriv over",
    transferMarketOverwriteProfileCancel: "Tillbaka",
    transferMarketProfileSaved: "Profil sparad.",
    transferMarketProfileOverwritten: "Profil overskriven.",
    transferMarketPastSearchesTitle: "Tidigare sokningar",
    transferMarketPastSearchesEmpty: "Inga tidigare sokningar.",
