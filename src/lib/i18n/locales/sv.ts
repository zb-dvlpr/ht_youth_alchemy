...
export const messagesSv: Messages = {
    ...
    seniorOtherOrdersManMarkingBestRejectedPair: "Minst ogynnsamma utvärderade par:",
    ...
    seniorOtherOrdersManMarkingCurrentPairSummary: "Beräkningen nedan gäller det par som är valt just nu.",
    ...
    seniorOtherOrdersManMarkingTargetLoss: "Påverkad contribution borttagen",
    seniorOtherOrdersManMarkingTargetRetained: "Påverkad contribution kvar",
    seniorOtherOrdersManMarkingMarkerPenalty: "Markerares egenstraff",
